...
**Generated:** 2026-09-10T16:32:48.508Z  
...
| **Total Lines of Code (LOC)** | `285,639` lines |
| **Comment Lines** | `27,273` lines |
| **Blank Lines** | `34,685` lines |
| **Total Codebase Size** | `14466.2` KB |
...
| **`modular_vehicle`** | 102 | 29,326 | 1474.1 KB | 50-chassis platforms, aggregator, validation engine & bridges |
...
| **`state_management`** | 35 | 10,515 | 437.7 KB | Zustand master store slices for vehicle & assembly configurations |
| **`ai_agent_framework`** | 36 | 3,969 | 181.7 KB | Domain engineering agents (Aero, Thermal, Brake, Homologation) |
| **`ui_components`** | 240 | 63,787 | 3221.5 KB | Workshop decks, 3-column configurator, SVG diagrams & ribbon UI |
| **`asset_pipeline`** | 0 | 0 | 0.0 KB | 3D glTF/GLB loaders, hardpoint manifests & asset catalogs |
| **`testing_verification`** | 82 | 13,151 | 687.4 KB | Automated test runners, assertion suites & unit tests |
...
|---|---|---|---|
| `src/utils/hmiSoundSynth.ts` | 79 | 0 | **79** |
...
| `src/state/DesignContext.tsx` | 35 | 4 | **39** |
