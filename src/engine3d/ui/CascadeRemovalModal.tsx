    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-150">
      <div className="w-full max-w-md bg-slate-900 border border-slate-700/80 rounded-2xl shadow-2xl p-6 text-slate-100">
        <div className="flex items-center gap-3 text-amber-400 mb-4">
          ...
          <h3 className="text-lg font-bold text-slate-100">Uninstall Dependency Warning</h3>
        </div>
        ...
        {/* Downstream Tree */}
        <div className="bg-slate-950/70 border border-slate-800 rounded-xl p-3 max-h-48 overflow-y-auto space-y-1.5 mb-4 text-xs font-mono">
        ...
        <div className="text-xs text-slate-400 mb-6 flex justify-between font-mono bg-slate-950/40 p-2.5 rounded-lg border border-slate-800/60">
