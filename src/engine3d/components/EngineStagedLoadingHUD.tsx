...
export const EngineStagedLoadingHUD: React.FC = () => {
  ...
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-40 flex flex-col items-center gap-1.5 px-4 py-2 rounded-2xl bg-slate-950/90 border border-amber-500/40 backdrop-blur-2xl shadow-[0_0_25px_rgba(6,182,212,0.3)] select-none transition-all duration-300 pointer-events-none">
