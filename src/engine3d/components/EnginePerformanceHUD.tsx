...
export const EnginePerformanceHUD: React.FC = () => {
  ...
  if (!isVisible) {
    return (
      <button
        ...
        className="absolute bottom-3 left-3 z-30 px-2.5 py-1.5 rounded-lg bg-slate-950/80 border border-cyan-500/30 text-cyan-400 text-[10px] font-mono font-bold hover:bg-slate-900 transition-all shadow-lg backdrop-blur-md flex items-center gap-1.5 cursor-pointer"
  ...
  return (
    <div className="absolute bottom-3 left-3 z-30 flex flex-col gap-1.5 max-w-[280px] select-none pointer-events-auto">
      ...
      <div className="flex items-center gap-2 p-2 rounded-xl bg-slate-950/85 border border-slate-800/80 backdrop-blur-xl shadow-2xl">
        ...
        <div className="flex flex-col text-[10px] font-mono text-slate-300">
          <span className="flex items-center gap-1">
            <Zap size={10} className="text-cyan-400" /> {metrics.frameTimeMs} ms
          </span>
        ...
        {metrics.isSleeping && (
          <span className="px-1.5 py-0.5 rounded bg-blue-500/20 border border-blue-400/30 text-blue-300 text-[9px] font-mono font-bold animate-pulse">
            SLEEP
          </span>
        )}
      ...
      {isExpanded && (
        <div className="p-3 rounded-xl bg-slate-950/95 border border-cyan-500/30 backdrop-blur-2xl shadow-2xl text-[10.5px] font-mono space-y-2 text-slate-300 animate-in fade-in slide-in-from-bottom-2 duration-150">
          ...
          <div className="grid grid-cols-2 gap-1.5 text-[10px]">
            <div className="p-1.5 rounded-lg bg-slate-900/60 border border-slate-800">
              ...
              <span className="font-bold text-cyan-400">{metrics.drawCalls}</span>
            </div>
            <div className="p-1.5 rounded-lg bg-slate-900/60 border border-slate-800">
            ...
            <div className="p-1.5 rounded-lg bg-slate-900/60 border border-slate-800">
              ...
              <span className="font-bold text-violet-300">{metrics.memoryEstimateMB} MB</span>
            </div>
            <div className="p-1.5 rounded-lg bg-slate-900/60 border border-slate-800">
