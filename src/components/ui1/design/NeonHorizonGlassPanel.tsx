...
export const NeonHorizonGlassPanel: React.FC<NeonHorizonGlassPanelProps> = ({
  ...
  const variantStyles = {
    primary:
      "bg-amber-950/80 backdrop-blur-2xl border border-white/10 shadow-[0_18px_44px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.08)]",
    secondary:
      "bg-amber-950/70 backdrop-blur-xl border border-white/8 shadow-[0_12px_32px_rgba(0,0,0,0.38),inset_0_1px_0_rgba(255,255,255,0.06)]",
    tertiary:
      "bg-amber-950/50 backdrop-blur-lg border border-white/6 shadow-[0_8px_20px_rgba(0,0,0,0.30)]",
    floating:
      "bg-amber-950/90 backdrop-blur-3xl border border-white/12 shadow-[0_24px_60px_rgba(0,0,0,0.55),inset_0_1px_0_rgba(255,255,255,0.10)]",
    inset:
      "bg-amber-950/85 backdrop-blur-md border border-white/6 shadow-[inset_0_2px_8px_rgba(0,0,0,0.45)]",
    window:
      "bg-amber-950/85 backdrop-blur-3xl border border-white/12 shadow-[0_28px_70px_rgba(0,0,0,0.60),inset_0_1px_0_rgba(255,255,255,0.10)]",
  }[variant];
