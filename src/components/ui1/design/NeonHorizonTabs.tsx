...
export const NeonHorizonTabs: React.FC<NeonHorizonTabsProps> = ({
  ...
  const containerStyles = {
    glass:
      "bg-amber-950/80 backdrop-blur-xl p-1 rounded-2xl border border-sky-400/15 shadow-inner flex items-center gap-1 overflow-x-auto no-scrollbar",
    pills:
    ...
    compact:
      "bg-amber-950/80 p-0.5 rounded-xl border border-white/10 flex items-center gap-0.5",
  }[variant];
