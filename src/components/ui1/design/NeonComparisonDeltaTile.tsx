...
export function NeonComparisonDeltaTile({ label, value, unit, delta, deltaLabel, higherIsBetter = true, accentColor = "#38bdf8", className = "" }: {
  ...
  return (
    <NeonEntrance type="scale-pop" className={"p-3 rounded-xl bg-[#0a1628]/80 border border-white/[0.08] backdrop-blur-md relative overflow-hidden group hover:border-white/[0.15] transition-all " + className}>
