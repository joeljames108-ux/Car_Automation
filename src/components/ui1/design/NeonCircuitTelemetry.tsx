  ...
  return (
    <div className="panel p-4 rounded-2xl space-y-3">
      <div className="flex items-center justify-between">
        <div><span className="text-[9px] font-mono text-sky-400/80 uppercase tracking-widest font-bold">Circuit Telemetry</span><h4 className="text-sm font-bold text-slate-800 dark:text-amber-50">{trackName}</h4></div>
        <div className="text-right"><span className="text-xs font-mono text-amber-500 dark:text-amber-100/80">{lengthKm} km</span><div className="text-[10px] text-amber-300/50 dark:text-amber-200/60 font-mono">{turns} Turns</div></div>
      </div>
