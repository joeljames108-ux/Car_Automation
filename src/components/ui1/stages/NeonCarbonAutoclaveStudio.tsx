          ...
          >
            <div className="grid grid-cols-8 gap-2 p-4 rounded-xl bg-amber-950/60 border border-sky-400/25 shadow-[inset_0_0_20px_rgba(0,0,0,0.8)]">
              {["0°", "+45°", "-45°", "90°", "0°", "+45°", "-45°", "90°", "90°", "-45°", "+45°", "0°", "90°", "-45°", "+45°", "0°"].map((ply, idx) => (
                <div key={idx} className="p-2.5 rounded-lg bg-amber-950/60 border border-white/10 flex flex-col items-center justify-center font-mono text-[10px] text-center">
