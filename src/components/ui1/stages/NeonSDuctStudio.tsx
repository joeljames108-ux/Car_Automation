          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Boundary Layer Bleed:</span>
                <span className="text-emerald-300 font-bold">NACA Lower Inlet Active</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Hood Vortex Core:</span>
                <span className="text-amber-300 font-bold">Helical Flow Coherent</span>
              </div>
            </div>
          </NeonHorizonGlassPanel>
        </div>
