...
export function NeonBrakeLabStudio() {
    ...
    <div className="w-full flex flex-col gap-6 text-slate-100 animate-nh-materialize">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          >
            <div className="grid grid-cols-10 gap-1.5 h-36 p-4 rounded-xl bg-amber-950/80 border border-sky-400/25 items-end shadow-[inset_0_0_20px_rgba(0,0,0,0.8)]">
 ...
 : "bg-amber-500/40"
                    ...
                    />
                    <span className="text-[9px] font-mono font-bold text-amber-300/60">#{idx + 1}</span>
                  </div>
                );
              })}
            </div>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          >
            <div className="flex flex-col gap-2">
              <span className="text-xs font-bold text-amber-200/70">Brake Disc Metallurgy:</span>
 ...
 : "bg-amber-950/80 border-white/10 text-amber-300/60 hover:border-sky-400/25"
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Front Caliper:</span>
                <span className="text-amber-300 font-bold">10-Piston Monobloc Titanium</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Rotor Dimension:</span>
