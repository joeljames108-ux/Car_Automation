          ...
          >
            <div className="grid grid-cols-3 gap-3 p-4 rounded-xl bg-amber-950/80 border border-sky-400/25 font-mono text-xs">
              <div className="p-3 rounded-lg bg-amber-950/80 border border-white/10 flex flex-col items-center">
                <span className="text-amber-300/60 text-[10px]">Phase U</span>
                <span className="text-amber-300 font-bold text-sm">800V · 450A</span>
                <span className="text-emerald-400 text-[10px]">0.02% THD</span>
              </div>
              <div className="p-3 rounded-lg bg-amber-950/80 border border-white/10 flex flex-col items-center">
                <span className="text-amber-300/60 text-[10px]">Phase V</span>
                <span className="text-amber-300 font-bold text-sm">800V · 450A</span>
                <span className="text-emerald-400 text-[10px]">0.02% THD</span>
              </div>
              <div className="p-3 rounded-lg bg-amber-950/80 border border-white/10 flex flex-col items-center">
                <span className="text-amber-300/60 text-[10px]">Phase W</span>
                <span className="text-amber-300 font-bold text-sm">800V · 450A</span>
                <span className="text-emerald-400 text-[10px]">0.02% THD</span>
              </div>
            </div>
          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Power Density:</span>
                <span className="text-emerald-300 font-bold">28.5 kW / kg</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Direct Oil Flowrate:</span>
