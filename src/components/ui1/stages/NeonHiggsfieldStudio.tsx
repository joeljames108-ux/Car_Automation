...
function JobCard({ job }: { job: GenerationJob }) {
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-amber-950/80 overflow-hidden">
...
function PromptBox({ value, onChange }: { value: string; onChange: (v: string) => void }) {
  return (
    <textarea
      ...
      rows={3}
      className="w-full rounded-xl bg-amber-950/85 border border-white/10 focus:border-sky-400/35 outline-none px-3 py-2.5 text-[11px] leading-relaxed text-amber-100 font-mono resize-none"
      spellCheck={false}
    />
  );
}
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between gap-3">
              <input
                ...
                className="flex-1 rounded-lg bg-amber-950/85 border border-white/10 focus:border-amber-500/30 outline-none px-3 py-2 text-[11px] text-amber-100 placeholder:text-slate-600"
              />
      ...
      >
        <div className="p-4 flex flex-col gap-3">
          ...
          <div className="grid md:grid-cols-2 gap-3 mt-1">
            {shots.map((s) => (
              <div key={s.shot} className="rounded-xl border border-white/10 bg-amber-950/70 p-3 flex flex-col gap-2">
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        <div className="p-4 flex flex-col gap-3">
          ...
          {jobs.length > 0 && (
            <div className="rounded-xl border border-white/10 bg-amber-950/70 p-3">
        ...
        {backend === "api" && (
          <div className="px-4 pb-4">
            ...
            <input
              ...
              className="w-full rounded-lg bg-amber-950/85 border border-white/10 focus:border-amber-500/30 outline-none px-3 py-2 text-[11px] font-mono text-amber-100"
            />
