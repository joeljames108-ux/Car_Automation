  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      for (let i = 0; i < 4; i++) {
        ...
        ctx.fillStyle = i % 2 === 0 ? "#8fb9d9" : "#9d8fc4";
        ctx.beginPath();
          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Array Configuration:</span>
                <span className="text-emerald-300 font-bold">12x Counter-Rotating Pairs</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Boundary Layer Thickness:</span>
