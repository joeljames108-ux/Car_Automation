          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Front LiDAR Range:</span>
                <span className="text-amber-300 font-bold">300 meters</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Triple Camera FOV:</span>
                <span className="text-emerald-300 font-bold">120° Panoramic</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">4D Radar Elevation:</span>
