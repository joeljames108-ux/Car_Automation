    ...
    <div className="w-full flex flex-col gap-6 text-slate-100 animate-nh-materialize">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-3">
          ...
          >
            {checks.map((check) => (
              <div
                key={check.id}
                className="p-3.5 rounded-xl bg-amber-950/80 border border-white/10 flex items-center justify-between font-mono text-xs"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-amber-300/60">Rule: {check.req}</span>
                  </div>
                </div>
                <div className="flex items-center gap-3">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          >
            {passportIssued ? (
              <div className="w-full flex flex-col items-center gap-3 p-4 rounded-xl bg-amber-950/80 border border-amber-400/40 animate-nh-materialize">
              ...
              <div className="w-full flex flex-col items-center gap-4 py-6">
                <span className="text-xs text-amber-300/60 max-w-xs">
