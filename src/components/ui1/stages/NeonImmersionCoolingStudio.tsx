...
export function NeonImmersionCoolingStudio() {
 ...
 : "bg-amber-500/20 border-sky-400/25 text-amber-300"
            ...
            <div className="flex flex-col gap-2">
              <span className="text-xs font-bold text-amber-200/70">Immersion Dielectric Chemistry:</span>
          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Fluid Boiling Point:</span>
                <span className="text-amber-300 font-bold">110°C (Phase Change)</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Dielectric Breakdown:</span>
