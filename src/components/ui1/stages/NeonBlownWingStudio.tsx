...
export function NeonBlownWingStudio() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      ctx.fillStyle = isHot ? "#ff0055" : "#38bdf8";
      ...
      for (let i = 0; i < 5; i++) {
        ...
        ctx.fillStyle = isHot ? (i % 2 === 0 ? "#ff0055" : "#fbbf24") : "#38bdf8";
        ctx.beginPath();
          ...
          >
            <div className="w-full h-52 bg-[#030712] rounded-xl border border-sky-400/25 overflow-hidden relative shadow-[inset_0_0_25px_rgba(0,0,0,0.85)]">
              ...
              <div className="absolute top-2 left-3 flex items-center gap-2">
                <span className={`text-[10px] nh-font-mono font-bold ${isHot ? "text-amber-400" : "text-sky-300"}`}>
