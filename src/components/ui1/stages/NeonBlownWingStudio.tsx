...
export function NeonBlownWingStudio() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      ctx.fillStyle = isHot ? "#ff0055" : "#00e5ff";
      ...
      for (let i = 0; i < 5; i++) {
        ...
        ctx.fillStyle = isHot ? (i % 2 === 0 ? "#ff0055" : "#fbbf24") : "#00e5ff";
        ctx.beginPath();
          ...
          >
            <div className="w-full h-52 bg-[#030712] rounded-xl border border-cyan-500/30 overflow-hidden relative shadow-[inset_0_0_25px_rgba(0,0,0,0.85)]">
              ...
              <div className="absolute top-2 left-3 flex items-center gap-2">
                <span className={`text-[10px] nh-font-mono font-bold ${isHot ? "text-amber-400" : "text-cyan-300"}`}>
          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-[#060e22] border border-cyan-500/20 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-slate-400">Wing Heat Shielding:</span>
                <span className="text-emerald-300 font-bold">Gold Foil + Ceramic TBC</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-slate-400">Off-Throttle Strategy:</span>
