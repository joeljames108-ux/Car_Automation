          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Side Floor Strakes:</span>
                <span className="text-emerald-300 font-bold">6x Vortex Retention Curtains</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">FIA Skid Block Wear:</span>
                <span className="text-amber-300 font-bold">0.18 mm / 100 km (Legal)</span>
              </div>
            </div>
          </NeonHorizonGlassPanel>
        </div>
