    ...
    <div className="w-full flex flex-col gap-6 text-slate-100 animate-nh-materialize">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          >
            <div className="p-4 rounded-xl bg-[#030712] border border-cyan-500/30 font-mono text-xs flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <span className="text-slate-400">Enclosure Pressure:</span>
                <span className="text-cyan-300 font-bold">10⁻⁴ mbar High Vacuum</span>
              </div>
              <div className="flex items-center justify-between">
          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-[#060e22] border border-cyan-500/20 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                ...
                <span className="text-cyan-300 font-bold">850 m/s (Mach 2.5)</span>
              </div>
              <div className="flex items-center justify-between">
