...
export function NeonGarageStudio() {
 ...
 : "bg-amber-950/80 border-white/10 text-amber-200/70 hover:border-sky-400/25"
 }`}
                  >
                    {preset.name}
                  </div>
            ...
            <div className="p-4 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 mt-2">
              <div className="flex items-center justify-between">
                <span className="text-xs text-amber-300/60">VIN Chassis Serial:</span>
                <span className="text-xs font-bold nh-font-mono text-amber-300">APX-2026-00984-GTX</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-amber-300/60">Assembly Location:</span>
                <span className="text-xs font-bold nh-font-mono text-amber-300">Apex Skunkworks Plant 01</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-amber-300/60">Track Homologation:</span>
