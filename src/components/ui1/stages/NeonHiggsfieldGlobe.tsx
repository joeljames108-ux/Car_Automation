          ...
          return (
            ...
            >
              ...
              <div className="mt-2 pt-1.5 border-t border-white/[0.06] flex items-center justify-between z-10">
                ...
                <ArrowRight size={10} className={`transition-transform duration-200 ${isActive ? "text-sky-400 translate-x-0.5" : "text-slate-600 group-hover:text-slate-300 group-hover:translate-x-1"}`} />
              </div>
            </button>
          );
        })}
