            ...
            <div className="grid grid-cols-2 gap-4 p-4 rounded-xl bg-amber-950/80 border border-sky-400/25 shadow-[inset_0_0_20px_rgba(0,0,0,0.8)]">
              {[
                ...
                <div key={idx} className="p-3 rounded-lg bg-amber-950/80 border border-white/10 flex flex-col gap-1 font-mono text-xs">
                  <span className="text-[10px] text-amber-300/60 font-bold">{wheel.pos}</span>
                  <div className="flex items-center justify-between">
                    <span className="text-amber-300/60">Torque:</span>
                    <span className={`${wheel.color} font-bold text-sm`}>{wheel.torque}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-amber-300/60">Vector State:</span>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Response Rate:</span>
                <span className="text-amber-300 font-bold">1,000 Hz CAN-FD Loop</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Max Regen Vector:</span>
