    ...
    <div className="w-full flex flex-col gap-6 text-slate-100 animate-nh-materialize">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          >
            <div className="grid grid-cols-2 gap-4 p-4 rounded-xl bg-amber-950/80 border border-sky-400/25 shadow-[inset_0_0_20px_rgba(0,0,0,0.8)]">
              {[
                ...
                <div key={idx} className="p-3 rounded-lg bg-amber-950/80 border border-white/10 flex flex-col gap-1 font-mono text-xs">
                  <span className="text-[10px] text-amber-300/60 font-bold">{strut.pos}</span>
                  <div className="flex items-center justify-between">
                    <span className="text-amber-300/60">Pressure:</span>
                    <span className={`${strut.color} font-bold`}>{strut.pressure}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-amber-300/60">Venturi Gap:</span>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">48V Pump Power:</span>
                <span className="text-amber-300 font-bold">12 kW Peak Electric</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Road Preview LiDAR:</span>
