          ...
          >
            <div className="grid grid-cols-3 gap-3 p-4 rounded-xl bg-[#05080f] border border-sky-400/25 font-mono text-xs">
              <div className="p-3 rounded-lg bg-[#0a111e] border border-white/10 flex flex-col items-center">
                <span className="text-amber-200/60 text-[10px]">Inlet Temp</span>
                <span className="text-amber-400 font-bold text-sm">985°C EGT</span>
                <span className="text-amber-300/50 text-[10px]">Inconel 718</span>
              </div>
              <div className="p-3 rounded-lg bg-[#0a111e] border border-white/10 flex flex-col items-center">
                <span className="text-amber-200/60 text-[10px]">Pressure Ratio</span>
                <span className="text-sky-300 font-bold text-sm">3.85 : 1 P₃/P₁</span>
                <span className="text-emerald-400 text-[10px]">High Surge Margin</span>
              </div>
              <div className="p-3 rounded-lg bg-[#0a111e] border border-white/10 flex flex-col items-center">
                <span className="text-amber-200/60 text-[10px]">Shaft Bearings</span>
                <span className="text-sky-300 font-bold text-sm">Dual Ceramic Ball</span>
                <span className="text-sky-400 text-[10px]">Water-Cooled CHRA</span>
              </div>
            </div>
          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-[#0a111e] border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-200/60">Turbine Wheel:</span>
                <span className="text-emerald-300 font-bold">Titanium-Aluminide (TiAl)</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-200/60">Wastegate Bypass:</span>
                <span className="text-sky-300 font-bold">Internal Electronic Diverter</span>
              </div>
            </div>
          </NeonHorizonGlassPanel>
        </div>
