...
export function NeonSimulationStudio() {
 ...
 : "bg-amber-950/60 border-white/10 hover:border-sky-400/25"
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          >
            <div className="p-3.5 rounded-xl bg-amber-950/60 border border-sky-400/15 flex items-center justify-between">
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/60 border border-emerald-400/30 flex items-center justify-between mt-2">
