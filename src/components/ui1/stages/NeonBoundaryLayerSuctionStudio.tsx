          ...
          >
            ...
            <div className="p-3.5 rounded-xl bg-amber-950/80 border border-sky-400/15 flex flex-col gap-2 font-mono text-xs">
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Drilling Method:</span>
                <span className="text-emerald-300 font-bold">Femtosecond UV Laser</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-amber-300/60">Suction Source:</span>
                <span className="text-amber-300 font-bold">48V Brushless Micro-Impellers</span>
              </div>
            </div>
          </NeonHorizonGlassPanel>
        </div>
