    ...
    <div className="w-full flex flex-col gap-6 text-slate-100 animate-nh-materialize">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          >
            <div className="w-full h-44 bg-amber-950/80 rounded-xl border border-sky-400/25 overflow-hidden relative shadow-[inset_0_0_20px_rgba(0,0,0,0.8)]">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          >
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-amber-950/80 border border-sky-400/15">
              <div className="flex flex-col">
                <span className="text-xs font-bold text-amber-100">Active Exhaust Bypass Valves</span>
                <span className="text-[10px] text-amber-300/60">Open for full unmuffled racing resonance</span>
              </div>
              <NeonHorizonToggle
            ...
            <div className="flex flex-col gap-2">
              <span className="text-xs font-bold text-amber-200/70">Exhaust Header Metallurgy:</span>
