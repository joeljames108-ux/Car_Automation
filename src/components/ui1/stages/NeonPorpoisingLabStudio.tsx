      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          >
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-amber-950/80 border border-white/10 font-mono text-xs">
              <span className="text-amber-300/60">Venturi Throat Expansion:</span>
              <span className="text-amber-300 font-bold">1:4.8 Diffuser Aspect</span>
              <span className="text-amber-300/60">Floor Edge Skirt Vortex:</span>
