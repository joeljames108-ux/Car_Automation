...
export function NeonHorizonAlertBanner({
  ...
  const accentClasses =
    type === "danger"
      ...
      : "bg-amber-900/40 border-sky-400/30 text-sky-200";
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="p-1 rounded-lg hover:bg-white/10 transition-colors text-amber-100/80 hover:text-white cursor-pointer"
      >
        <X size={16} />
      </button>
    </div>
