...
export function NeonHorizonCommandPalette({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-24 px-4 bg-black/75 backdrop-blur-md animate-nh-materialize">
      <div className="w-full max-w-2xl bg-amber-950/95 border border-white/12 rounded-2xl overflow-hidden flex flex-col shadow-[0_30px_80px_rgba(0,0,0,0.65)]">
        {/* Search Input Bar */}
 ...
 : "text-amber-200/70 hover:bg-white/5 border border-transparent"
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <ArrowRight size={12} className={isSelected ? "text-amber-400" : "text-transparent"} />
                  </div>
                </div>
              );
            })
        ...
        <div className="px-5 py-2.5 bg-black/30 border-t border-white/8 flex items-center justify-between text-[11px] nh-font-mono text-amber-300/60">
          ...
          <span className="text-amber-300/90 font-bold">Apex AI Quick Engine</span>
        </div>
      </div>
    </div>
  );
