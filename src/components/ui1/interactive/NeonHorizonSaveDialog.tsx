...
export function NeonHorizonSaveDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-nh-materialize">
      <div className="w-full max-w-xl bg-amber-950/80 border border-white/12 rounded-2xl shadow-[0_30px_80px_rgba(0,0,0,0.65)] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/8 bg-black/30">
          <div className="flex items-center gap-2">
            <Save size={18} className="text-amber-300/90" />
          ...
          <button onClick={onClose} className="text-amber-300/60 hover:text-amber-100 cursor-pointer">
            <X size={16} />
          </button>
        </div>
        ...
        <div className="p-6 flex flex-col gap-3 nh-scroll">
          <span className="nh-label-caps text-amber-300/60 text-[10px]">BLUEPRINT STORAGE SLOTS</span>
 ...
 : "bg-amber-950/80 border-white/10 hover:border-sky-400/25"
                ...
                >
                  <div>
                    ...
                    <span className="text-[10px] nh-font-mono text-amber-300/60">
