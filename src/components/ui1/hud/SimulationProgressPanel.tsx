    ...
    >
      ...
      <div className="flex items-center gap-3 p-2.5 rounded-xl bg-white/[0.04] border border-white/10">
        ...
        <div className="min-w-0">
          ...
          <span className="text-[10px] nh-font-mono text-amber-300/60 block uppercase tracking-wider">
      ...
      <div className="flex flex-col gap-2.5">
        <div className="flex items-center justify-between p-2 rounded-xl bg-amber-950/80/60 border border-white/6">
          ...
          <div className="flex items-baseline gap-1">
            ...
            <span className="text-[10px] nh-font-mono text-amber-300/60">hp</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between p-2 rounded-xl bg-amber-950/80/60 border border-white/6">
          ...
          <div className="flex items-baseline gap-1">
            ...
            <span className="text-[10px] nh-font-mono text-amber-300/60">Nm</span>
          </div>
        </div>
