    ...
    >
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        <div className="p-3 rounded-xl bg-[#0e1626]/70 border border-white/6 flex flex-col justify-between">
          <span className="nh-label-caps text-amber-200/60 text-[9px] mb-1">TOTAL WEIGHT</span>
          <div className="flex items-baseline gap-1">
            <span className="text-lg font-bold nh-font-headline text-amber-50">
        ...
        {/* Power / Weight */}
        <div className="p-3 rounded-xl bg-[#0e1626]/70 border border-white/6 flex flex-col justify-between">
          <span className="nh-label-caps text-amber-200/60 text-[9px] mb-1">POWER / WEIGHT</span>
          <div className="flex items-baseline gap-1">
            <span className="text-lg font-bold nh-font-headline text-amber-50">
              <AnimatedCounter value={Math.round(powerToWeight)} />
            </span>
            <span className="text-[10px] nh-font-mono text-amber-200/60">hp/t</span>
          </div>
        </div>

        {/* Top Speed */}
        <div className="p-3 rounded-xl bg-[#0e1626]/70 border border-white/6 flex flex-col justify-between">
          <span className="nh-label-caps text-amber-200/60 text-[9px] mb-1">TOP SPEED</span>
          <div className="flex items-baseline gap-1">
            <span className="text-lg font-bold nh-font-headline text-amber-50">
              <AnimatedCounter value={topSpeed} />
            </span>
            <span className="text-[10px] nh-font-mono text-amber-200/60">km/h</span>
          </div>
        </div>

        {/* 0-60 MPH */}
        <div className="p-3 rounded-xl bg-[#0e1626]/70 border border-white/6 flex flex-col justify-between">
          <span className="nh-label-caps text-amber-200/60 text-[9px] mb-1">0-60 MPH</span>
          <div className="flex items-baseline gap-1">
        ...
        {/* Quarter Mile */}
        <div className="p-3 rounded-xl bg-[#0e1626]/70 border border-white/6 flex flex-col justify-between">
          <span className="nh-label-caps text-amber-200/60 text-[9px] mb-1">QUARTER MILE</span>
          <div className="flex items-baseline gap-1">
        ...
        {/* Braking 100-0 */}
        <div className="p-3 rounded-xl bg-[#0e1626]/70 border border-white/6 flex flex-col justify-between">
          <span className="nh-label-caps text-amber-200/60 text-[9px] mb-1">BRAKING 100-0</span>
          <div className="flex items-baseline gap-1">
            <span className="text-lg font-bold nh-font-headline text-rose-300">
              {braking100To0.toFixed(1)}
            </span>
            <span className="text-[10px] nh-font-mono text-amber-200/60">m</span>
          </div>
        </div>
      </div>
    </NeonHorizonGlassPanel>
