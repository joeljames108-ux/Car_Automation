  ...
  return (
    <div className="relative w-full flex flex-col items-center">
                  ...
                  <div className="flex items-center gap-1.5">
                    <span
                      className={`text-xs font-bold tracking-wide ${
                        isActive ? "text-white" : "text-amber-200/70 group-hover:text-white"
                      }`}
                    >
                      {s.label}
                    </span>
                  ...
                  <ArrowRight
                    ...
                    className={`transition-transform duration-200 ${
                      isActive
                        ...
                        : "text-slate-600 group-hover:text-amber-200/70 group-hover:translate-x-1"
                    }`}
                  />
                </div>
              </button>
      ...
      >
        ...
        <span className={`${cornerCls} top-2.5 left-3.5 flex items-center gap-1.5 text-amber-300/60`}>
          <Navigation size={10} /> 3D SPATIAL NAV · SATELLITE ORBIT
        </span>
        <span ref={readoutRef} className={`${cornerCls} bottom-2.5 left-3.5 text-amber-300/60`} />
        <span
        ...
        <span className={`${cornerCls} top-2.5 right-3.5 flex items-center gap-1.5 text-amber-300/60`}>
          <Crosshair size={10} />
        </span>
