...
export const THEME_PRESETS: Record<UI1VibeTheme, KineticThemeTokens> = {
  kinetic_horizon: {
    id: "kinetic_horizon",
    name: "Quanta Obsidian",
    description: "Obsidian void, electric cyan & hypercar amber — Quanta studio standard",
    bgRoot: "#08090D",
    panelBg: "rgba(10, 15, 26, 0.85)",
    primaryGlow: "rgba(0, 245, 212, 0.35)",
    secondaryGlow: "rgba(255, 183, 3, 0.25)",
    accentText: "#00F5D4",
    borderColor: "rgba(255, 255, 255, 0.10)",
    btnBg: "rgba(255, 255, 255, 0.05)",
    btnBorder: "rgba(255, 255, 255, 0.14)",
    scanlineGradient: "linear-gradient(180deg, transparent 0%, rgba(0, 245, 212, 0.02) 50%, rgba(0, 245, 212, 0.04) 51%, transparent 100%)",
    badgeBg: "rgba(0, 245, 212, 0.12)",
    badgeText: "#00F5D4",
    chartPrimary: "#00F5D4",
    chartSecondary: "#FFB703",
  },
  cyberpunk_neon: {
    id: "cyberpunk_neon",
    name: "Cyberpunk Neon",
