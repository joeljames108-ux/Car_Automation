              ...
              <div className="flex justify-center items-center p-8 bg-slate-900/80/80 rounded-2xl border border-sky-400/15 min-h-[300px] perspective-1000">
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-xs nh-font-mono font-bold text-amber-400 tracking-wider">APEX AUTOMOTIVE TELEMETRY</span>
                    <NeonHorizonBadge variant="magenta">HYPERCAR V8</NeonHorizonBadge>
                  </div>

                  <h4 className="text-xl font-black text-slate-100 mb-2 group-hover:text-amber-300 transition-colors">
              ...
              {[
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-[10px] nh-font-mono text-amber-300">{item.latency}</span>
