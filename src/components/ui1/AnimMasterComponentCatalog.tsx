      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          ...
          {activeTab === "tilt_cards" && (
            <NeonHorizonGlassPanel
              ...
              className="p-6"
            >
              <div className="flex justify-center items-center p-8 bg-[#05080f]/80 rounded-2xl border border-sky-400/15 min-h-[300px] perspective-1000">
                <div
                  ...
                  className="w-full max-w-md bg-[#111a2b]/90 p-6 rounded-2xl border border-sky-400/30 shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative overflow-hidden cursor-pointer group"
                >
                  {/* Dynamic Glare */}
                  <div
                    style={{
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <NeonHorizonGlassPanel
            ...
            className="p-4"
          >
            <pre className="p-3 rounded-xl bg-[#05080f] border border-sky-400/15 text-[11px] nh-font-mono text-sky-300 overflow-x-auto">
