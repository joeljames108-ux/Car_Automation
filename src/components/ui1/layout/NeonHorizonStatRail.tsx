...
export const NeonHorizonStatRail: React.FC<NeonHorizonStatRailProps> = ({ sim }) => {
  ...
  return (
    <div className="hidden xl:flex flex-col gap-4 w-72 shrink-0 select-none">
      <div className="sticky top-28 flex flex-col gap-4">
        ...
        <div className="p-5 rounded-3xl bg-amber-950/60/85 backdrop-blur-3xl border border-white/12 shadow-[0_25px_60px_rgba(0,0,0,0.60),inset_0_1px_0_rgba(255,255,255,0.10)] flex flex-col items-center gap-5 nh-edge-top">
 ...
 : "bg-white/[0.06] text-slate-300 hover:bg-white/[0.12] border border-white/8"
          ...
          <div className="w-full flex flex-col gap-2.5 pt-2 border-t border-white/10">
            {/* POWER */}
            <div className="flex items-center justify-between p-3 rounded-2xl bg-amber-950/60/70 border border-white/6 hover:border-amber-500/30 transition-colors">
