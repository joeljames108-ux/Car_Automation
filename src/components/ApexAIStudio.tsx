...
const ENGINEERS: Record<EngineerId, { label: string; icon: React.ReactNode; focus: string; tone: string; desc: string }> = {
  ...
  technology:     { label: "Technology Expert",     icon: <Cpu size={16} />,       focus: "800V EV & Electronics",  tone: "text-amber-400 border-sky-500/40 bg-amber-500/15", desc: "Supervises 800V inverter efficiency, cell thermal balancing, and infotainment." },
};
