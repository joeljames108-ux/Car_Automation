...
export const InteriorDashboardConfiguratorStudio: React.FC = () => {
  return (
    <div className="idash-root flex flex-col h-[calc(100vh-72px)] min-h-[640px] text-amber-100 font-sans select-none overflow-hidden rounded-2xl border border-amber-800/30 shadow-[0_16px_48px_rgba(0,0,0,0.4)]">
