...
export const InteriorEngineeringTelemetryDashboard: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-amber-950 text-slate-100 p-4 md:p-6 space-y-6 font-sans">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="p-5 rounded-3xl bg-amber-950/80/90 border border-amber-800/30 space-y-4">
          ...
          <div className="space-y-2">
            <div className="text-xs font-bold text-amber-200">ISO 7730 Fanger PMV / PPD Zones</div>
            <div className="space-y-1.5">
              {cfdSummary.thermalComfortZones.map((z) => (
                <div key={z.zoneName} className="p-2.5 rounded-xl bg-amber-950 border border-amber-800/30 flex items-center justify-between text-xs">
                  <span className="font-bold text-amber-100">{z.zoneName}</span>
        ...
        <div className="p-5 rounded-3xl bg-amber-950/80/90 border border-amber-800/30 space-y-4">
          ...
          <div className="space-y-2">
            <div className="text-xs font-bold text-amber-200">NVH Attenuation Spectrum (20 Hz - 500 Hz)</div>
            <div className="space-y-1">
              {nvhSpectrum.slice(0, 5).map((pt) => (
                <div key={pt.frequencyHz} className="flex items-center gap-2 text-[10px]">
                  <span className="w-12 text-amber-300/70 font-bold">{pt.frequencyHz} Hz</span>
                  <div className="flex-1 h-3 rounded-full bg-amber-950 overflow-hidden flex">
        ...
        <div className="p-5 rounded-3xl bg-amber-950/80/90 border border-amber-800/30 space-y-4">
          ...
          <div className="space-y-2 text-xs">
            <div className="p-3 rounded-2xl bg-amber-950 border border-amber-800/30 flex justify-between">
              <span className="text-amber-300/70">H-Point X/Y/Z:</span>
            ...
            <div className="p-3 rounded-2xl bg-amber-950 border border-amber-800/30 flex justify-between">
              <span className="text-amber-300/70">Headroom Clearance:</span>
