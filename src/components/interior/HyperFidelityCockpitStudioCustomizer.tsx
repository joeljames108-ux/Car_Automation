      ...
      <div className="flex items-center justify-between px-6 py-3.5 bg-amber-950/80/80/90 backdrop-blur-md border-b border-amber-800/30/80">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-amber-300/70">Phase 5 Procedural CAD, Anisotropic BRDF & Acoustic Raytracing</p>
          </div>
        </div>
        ...
        <div className="flex-1 h-full relative" ref={mountRef}>
          ...
          {acousticResult && (
            <div className="absolute bottom-4 left-4 z-20 flex items-center gap-4 px-4 py-2.5 bg-amber-950/80/80/90 backdrop-blur-md rounded-xl border border-amber-800/30/90 shadow-xl text-xs">
              ...
              <div className="text-amber-200">STI: <span className="text-emerald-400 font-medium">{acousticResult.speechTransmissionIndexSti}</span></div>
              <div className="h-4 w-px bg-amber-900/40" />
              <div className="text-amber-200">ANC: <span className="text-amber-400 font-medium">{acousticResult.activeNoiseCancellationAttenDb} dB</span></div>
              <div className="h-4 w-px bg-amber-900/40" />
              <div className="text-amber-200">Driver Sweetspot: <span className="text-amber-400 font-medium">{acousticResult.driverSweetSpotScore}%</span></div>
            </div>
          )}
        </div>
        ...
        <div className="w-80 bg-amber-950/80/80/95 backdrop-blur-xl border-l border-amber-800/30/90 p-5 flex flex-col gap-5 overflow-y-auto z-20">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="w-full h-1.5 bg-amber-900/40 rounded-lg appearance-none cursor-pointer accent-amber-400"
            />
          </div>
          ...
          <div className="flex flex-col gap-2.5 pt-2 border-t border-amber-800/30/80">
            <label className="flex items-center justify-between text-xs text-amber-200 cursor-pointer">
              ...
              <input
                ...
                className="w-4 h-4 rounded accent-amber-500 bg-amber-900/40 border-amber-700/30"
              />
            </label>
            <label className="flex items-center justify-between text-xs text-amber-200 cursor-pointer">
