...
export const LUXURY_MATERIAL_CATALOG: MaterialSwatchItem[] = [
  // Leather
  {
    ...
    category: "leather",
    previewGradient: "radial-gradient(circle at 35% 35%, #334155 0%, #0f172a 70%, #020617 100%)",
    roughness: 0.65,
    metalness: 0.1,
  ...
  },
  {
    ...
    category: "carbon",
    previewGradient: "radial-gradient(circle at 35% 35%, #64748b 0%, #334155 45%, #0f172a 100%)",
    roughness: 0.35,
    metalness: 0.75,
