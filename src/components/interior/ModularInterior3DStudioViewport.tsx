...
const ModularInterior3DStudioViewportComponent: React.FC<ModularInterior3DStudioViewportProps> = ({
  ...
  return (
    <div className="w-full flex flex-col space-y-3 select-none font-mono">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2.5 p-3 rounded-2xl backdrop-blur-xl bg-amber-950/80/90 border border-amber-800/30 shadow-xl">
        ...
        <div className="flex items-center gap-1 bg-amber-950 p-1 rounded-xl border border-amber-800/30 flex-wrap">
              ...
              <button
                ...
                className={`flex items-center gap-1 px-2 py-1 rounded-lg text-[10px] font-bold transition-all cursor-pointer ${
                  isSelected
                    ...
                    : "text-amber-300/70 hover:text-amber-100 hover:bg-slate-850"
                }`}
              >
                <Icon size={11} />
                <span>{c.label}</span>
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          <button
            ...
            className={`p-1.5 rounded-xl border text-xs transition-all cursor-pointer ${
              isAudioMuted
                ...
                : "bg-amber-950 border-amber-800/30 text-amber-200 hover:text-amber-50"
            }`}
          ...
          <button
            ...
            className={`flex items-center gap-1 px-2.5 py-1.5 rounded-xl text-[10px] font-bold border transition-all cursor-pointer ${
              doorOpenAngleDeg > 0
                ...
                : "bg-amber-950 border-amber-800/30 text-amber-300/70 hover:text-amber-100"
            }`}
          >
            <DoorOpen size={12} />
          ...
          {/* Environment Presets */}
          <div className="flex items-center bg-amber-950 p-0.5 rounded-xl border border-amber-800/30">
            {(
              [
      ...
      <div className="relative w-full h-[500px] md:h-[560px] rounded-3xl overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 border border-amber-800/30 shadow-2xl flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5">
        ...
        <div className="lg:col-span-7 p-3.5 rounded-2xl bg-amber-950/80/90 border border-amber-800/30 space-y-3 shadow-xl">
          ...
          <div className="space-y-1.5">
            <div className="text-[10px] text-amber-300/70 flex justify-between">
                ...
                <button
                  ...
                  className={`px-2 py-1.5 rounded-xl text-[10px] font-bold border transition-all truncate cursor-pointer flex items-center gap-1 ${
                    currentGazeTarget === hotspot.targetDescription
                      ...
                      : "bg-amber-950/80 border-amber-800/30 text-amber-300/70 hover:text-amber-100 hover:bg-slate-850"
                  }`}
                  title={hotspot.label}
                >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 pt-2 border-t border-amber-800/30/80 text-[10px]">
            {/* Head Pan */}
            <div className="p-2 rounded-xl bg-amber-950/70 border border-amber-800/30 space-y-1">
            ...
            <div className="p-2 rounded-xl bg-amber-950/70 border border-amber-800/30 flex items-center justify-between">
              <span className="text-amber-300/70">CROSSHAIR:</span>
              <button
                onClick={() => setShowCrosshair(!showCrosshair)}
                className={`px-2 py-0.5 rounded-lg font-bold border transition-all cursor-pointer ${
                  showCrosshair
                    ? "bg-amber-500/20 border-amber-500/50 text-amber-300"
                    : "bg-amber-950/80 border-amber-800/30 text-slate-500"
                }`}
              >
        ...
        <div className="lg:col-span-5 p-3.5 rounded-2xl bg-amber-950/80/90 border border-amber-800/30 space-y-3 shadow-xl">
          <div className="flex items-center justify-between border-b border-amber-800/30 pb-2">
            <div className="flex items-center gap-2">
              <div className="p-1.5 rounded-lg bg-amber-500/20 text-amber-300">
                <Tv size={14} />
          ...
          <div className="space-y-1.5">
            <div className="text-[10px] text-amber-300/70">INFOTAINMENT DASHBOARD STREAM:</div>
                ...
                <button
                  ...
                  className={`px-2 py-1.5 rounded-xl text-[10px] font-bold transition-all cursor-pointer ${
                    infotainmentMode === m.id
                      ...
                      : "bg-amber-950/80 border border-amber-800/30 text-amber-300/70 hover:text-amber-100"
                  }`}
                >
                  {m.label}
                </button>
          ...
          <div className="grid grid-cols-2 gap-2.5 pt-2 border-t border-amber-800/30/80 text-[10px]">
            {/* Exploded View */}
            <div className="p-2 rounded-xl bg-amber-950/70 border border-amber-800/30 space-y-1">
              <div className="flex justify-between text-amber-300/70">
