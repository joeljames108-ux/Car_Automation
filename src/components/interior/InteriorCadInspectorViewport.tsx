...
export const InteriorCadInspectorViewport: React.FC<InteriorCadInspectorViewportProps> = ({ state }) => {
  ...
  return (
    <div className="relative w-full h-[650px] rounded-3xl overflow-hidden border border-amber-800/30 shadow-2xl bg-amber-950 font-sans">
      {/* 3D WebGL Canvas */}
      <div
        ref={containerRef}
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold border transition-all cursor-pointer ${
            shadingMode === "wireframe_tech"
              ...
              : "bg-amber-950/80 border-amber-800/30 text-amber-200 hover:text-amber-50"
          }`}
        >
          <Layers size={13} />
        ...
        <div className="absolute top-20 right-4 w-72 p-4 rounded-2xl backdrop-blur-xl bg-amber-950/95 border border-amber-500/40 shadow-2xl space-y-3 z-20">
          <div className="flex items-center justify-between border-b border-amber-800/30 pb-2">
            ...
            <button
              ...
              className="text-amber-300/70 hover:text-amber-100 text-xs font-bold cursor-pointer"
            >
              ✕
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-[10px]">
            <div className="p-2 rounded-xl bg-amber-950/80 border border-amber-800/30">
              <span className="text-amber-300/70">Mass:</span>
              <div className="font-bold text-amber-300 text-xs">{selectedMeta.massKg} kg</div>
            </div>
            <div className="p-2 rounded-xl bg-amber-950/80 border border-amber-800/30">
              <span className="text-amber-300/70">Triangles:</span>
              <div className="font-bold text-amber-300 text-xs">{selectedMeta.triangleCount.toLocaleString()}</div>
            </div>
          </div>

          <div className="p-2 rounded-xl bg-amber-950/80 border border-amber-800/30 text-[10px]">
            <span className="text-amber-300/70">Bounding Box (X/Y/Z):</span>
