      ...
      <div className="idash-viewport-canvas">
        {viewportMode === "3d" ? (
          ...
          >
            ...
            <path d="M 85 170 Q 300 156 515 170 L 510 184 Q 300 170 90 184 Z" fill={getTrimFill()} stroke="#0f172a" strokeWidth="1.2" />
            ...
            {screenSize > 0 && (
              <g transform={`translate(${screenSize > 8 ? 260 : 272}, 128)`}>
                ...
                <rect x="3" y="3" width={screenSize > 8 ? 74 : 50} height="40" rx="2" fill="#0f172a" />
              </g>
            )}
