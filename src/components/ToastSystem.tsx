          ...
          <div
            ...
            className={`pointer-events-auto flex items-start gap-3 p-3.5 rounded-xl border backdrop-blur-xl shadow-2xl transition-all duration-300 animate-slide-left ${
              t.type === "success"
                ...
                : t.type === "warning"
                ? "bg-slate-900/90 border-amber-500/40 text-amber-200 shadow-amber-950/50"
                : t.type === "rd" ? "bg-purple-950/80 border-purple-500/50 text-purple-100 shadow-purple-950/50" : "bg-cyan-950/80 border-cyan-500/50 text-cyan-100 shadow-cyan-950/50"
            }`}
          >
