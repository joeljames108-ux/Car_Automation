...
export function ApexAgentConsole({
  ...
  return (
    <div
      className={`w-full bg-amber-950/60/90 border border-slate-800 rounded-3xl p-5 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.45)] text-slate-100 select-none space-y-4 ${className}`}
    >
