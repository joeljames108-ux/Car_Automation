        ...
        {agents.map((agent) => {
          ...
          return (
            <div
              ...
              className="p-5 bg-slate-900/60 backdrop-blur-md border border-slate-800 hover:border-amber-500/40 rounded-3xl transition-all cursor-pointer group flex flex-col justify-between gap-4"
            >
