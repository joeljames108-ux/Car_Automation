    ...
    <div className="space-y-6 animate-fade-in-up">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-right">
            <div className="text-2xl font-black font-mono text-amber-400 flex items-center gap-2 justify-end">
              ...
              <span className="text-xs text-amber-200/60 font-normal">kg DF</span>
              {deltas.downforce !== 0 && (
            ...
            <div className="text-[10px] text-amber-200/60 uppercase tracking-wider flex items-center gap-2 justify-end">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div className={`bg-amber-900/40 p-4 rounded-xl border transition-all space-y-3 ${
          showCompareBaseline && aero.packagePreset !== baselineAero.packagePreset ? "border-amber-500/50 bg-amber-500/5" : "border-amber-800/30"
        }`}>
          <label className="text-xs font-bold uppercase tracking-wider text-amber-100/80 flex items-center justify-between">
            <span className="flex items-center gap-1">
              ...
              <span title="Pre-indexed wing angle packages for specific circuit drag requirements"><HelpCircle size={12} className="text-amber-300/50 cursor-help" /></span>
            </span>
        ...
        <div className={`bg-amber-900/40 p-4 rounded-xl border transition-all space-y-2 ${
          showCompareBaseline && aero.frontWingFlapAngleDeg !== baselineAero.frontWingFlapAngleDeg ? "border-amber-500/50 bg-amber-500/5" : "border-amber-800/30"
        }`}>
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-amber-100/80 uppercase tracking-wider flex items-center gap-1">
              ...
              <span title="Controls front-end turn-in grip and front aero balance percentage"><HelpCircle size={12} className="text-amber-300/50 cursor-help" /></span>
            </span>
        ...
        <div className={`bg-amber-900/40 p-4 rounded-xl border transition-all space-y-2 ${
          showCompareBaseline && aero.rearWingMainPlaneAngleDeg !== baselineAero.rearWingMainPlaneAngleDeg ? "border-amber-500/50 bg-amber-500/5" : "border-amber-800/30"
        }`}>
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-amber-100/80 uppercase tracking-wider flex items-center gap-1">
              <span>Rear Wing Angle of Attack</span>
              <span title="Main rear downforce generator; higher angles increase high-speed stability but add straightline drag"><HelpCircle size={12} className="text-amber-300/50 cursor-help" /></span>
            </span>
        ...
        <div className={`bg-amber-900/40 p-4 rounded-xl border transition-all space-y-2 ${
          showCompareBaseline && aero.floorVenturiThroatHeightMm !== baselineAero.floorVenturiThroatHeightMm ? "border-amber-500/50 bg-amber-500/5" : "border-amber-800/30"
        }`}>
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-amber-100/80 uppercase tracking-wider flex items-center gap-1">
              <span>Venturi Tunnel Throat Gap</span>
              <span title="Floor ground-effect suction throat height; lower gaps yield massive downforce but risk aerodynamic stall & porpoising"><HelpCircle size={12} className="text-amber-300/50 cursor-help" /></span>
            </span>
        ...
        <div className={`bg-amber-900/40 p-4 rounded-xl border transition-all space-y-3 ${
          showCompareBaseline && aero.sidepodPhilosophy !== baselineAero.sidepodPhilosophy ? "border-amber-500/50 bg-amber-500/5" : "border-amber-800/30"
        }`}>
          <label className="text-xs font-bold uppercase tracking-wider text-amber-100/80 flex items-center justify-between">
            <span className="flex items-center gap-1">
              <span>Sidepod Bodywork Concept</span>
              <span title="Bodywork philosophy directing airflow toward rear diffuser and beam wing"><HelpCircle size={12} className="text-amber-300/50 cursor-help" /></span>
            </span>
        ...
        <div className={`bg-amber-900/40 p-4 rounded-xl border transition-all space-y-2 ${
          showCompareBaseline && aero.rearWingDrsFlapGapOpenMm !== baselineAero.rearWingDrsFlapGapOpenMm ? "border-amber-500/50 bg-amber-500/5" : "border-amber-800/30"
        }`}>
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-amber-100/80 uppercase tracking-wider flex items-center gap-1">
              <span>DRS Flap Opening Gap</span>
              <span title="Maximum gap when DRS actuator deploys. FIA Article 3.10 caps opening at 85mm max gap."><HelpCircle size={12} className="text-amber-300/50 cursor-help" /></span>
            </span>
