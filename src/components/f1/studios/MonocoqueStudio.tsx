        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            <div className="text-2xl font-black font-mono text-amber-400">
              {m.monocoqueTorsionalRigidityKNmDeg} <span className="text-xs text-amber-200/60 font-normal">kNm/deg</span>
            </div>
            <div className="text-[10px] text-amber-200/60 uppercase tracking-wider">Torsional Rigidity</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-amber-900/40 p-4 rounded-xl border border-amber-800/30 space-y-3">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            />
            <label htmlFor="haloAero" className="text-xs text-amber-100/80 cursor-pointer">
        ...
        <div className="bg-amber-900/40 p-4 rounded-xl border border-amber-800/30 space-y-2">
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-amber-100/80 uppercase tracking-wider">Cockpit Opening Width</span>
        ...
        <div className="bg-amber-900/40 p-4 rounded-xl border border-amber-800/30 space-y-2">
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-amber-100/80 uppercase tracking-wider">Torsional Rigidity Target</span>
        ...
        <div className="bg-amber-900/40 p-4 rounded-xl border border-amber-800/30 space-y-2">
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-amber-100/80 uppercase tracking-wider">Tungsten Ballast</span>
