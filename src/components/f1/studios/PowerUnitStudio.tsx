      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-amber-900/40 p-4 rounded-xl border border-amber-800/30 space-y-2">
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-amber-100/80 uppercase tracking-wider">Static Compression Ratio</span>
        ...
        <div className="bg-amber-900/40 p-4 rounded-xl border border-amber-800/30 space-y-2">
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-amber-100/80 uppercase tracking-wider">Direct Injection Pressure</span>
        ...
        <div className="bg-amber-900/40 p-4 rounded-xl border border-amber-800/30 space-y-2">
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-amber-100/80 uppercase tracking-wider">MGU-K Motor Output</span>
