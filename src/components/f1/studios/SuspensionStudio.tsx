    ...
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="glass-panel p-6 border-amber-500/20 bg-gradient-to-r from-slate-900 via-slate-900/90 to-amber-950/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-right">
            ...
            <div className="text-[10px] text-slate-400 uppercase tracking-wider">Static Ride Heights</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div className={`bg-slate-900/60 p-4 rounded-xl border transition-all space-y-3 ${
          showCompareBaseline && s.frontLayout !== baselineSuspension.frontLayout ? "border-amber-500/50 bg-amber-500/5" : "border-slate-800"
        }`}>
        ...
        <div className={`bg-slate-900/60 p-4 rounded-xl border transition-all space-y-2 ${
          showCompareBaseline && s.frontRideHeightStaticMm !== baselineSuspension.frontRideHeightStaticMm ? "border-amber-500/50 bg-amber-500/5" : "border-slate-800"
        }`}>
        ...
        {/* 3. Rear Ride Height */}
        <div className={`bg-slate-900/60 p-4 rounded-xl border transition-all space-y-2 ${
          showCompareBaseline && s.rearRideHeightStaticMm !== baselineSuspension.rearRideHeightStaticMm ? "border-amber-500/50 bg-amber-500/5" : "border-slate-800"
        }`}>
          <div className="flex justify-between items-center text-xs">
            <span className="font-bold text-slate-300 uppercase tracking-wider flex items-center gap-1">
