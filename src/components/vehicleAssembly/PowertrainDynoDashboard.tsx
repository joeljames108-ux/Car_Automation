...
export const PowertrainDynoDashboard: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#080b12] text-gray-100 font-sans border border-[#1b2333] rounded-2xl overflow-hidden shadow-2xl">
      {/* Dyno Header */}
      <div className="flex items-center justify-between px-5 py-3.5 bg-[#0e131d] border-b border-[#1b2333]">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 bg-[#141b27] px-3 py-1.5 rounded-xl border border-red-500/30">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 p-5 flex flex-col space-y-4 overflow-y-auto">
          {/* Dyno Graph Card */}
          <div className="p-4 bg-[#0a0e16] rounded-2xl border border-[#1b2333] shadow-inner flex flex-col space-y-3">
            ...
            {/* SVG Dyno Graph */}
            <div className="relative h-64 w-full bg-[#07090f] rounded-xl border border-[#161c28] p-2 flex items-center justify-center">
          ...
          <div className="p-4 bg-[#0a0e16] rounded-2xl border border-[#1b2333] flex flex-col space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-gray-300 flex items-center gap-2">
