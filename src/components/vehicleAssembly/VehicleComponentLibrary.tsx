        ...
        {filteredComponents.map((comp) => {
          ...
          return (
            ...
            >
              ...
              {/* Description */}
              <p className="text-[10px] text-slate-400 leading-normal mb-2.5 line-clamp-2">
                {comp.description}
              </p>
              ...
              {comp.variants.length > 0 && (
                <div className="mb-2.5">
                  <span className="text-[9px] font-mono text-slate-400 uppercase font-bold block mb-1 flex items-center gap-1">
              ...
              <StatDeltaBadges meta={comp as any} variant={variantObj} size="sm" className="pt-1.5 border-t border-slate-800/80" />
            </div>
          );
        })}
      </div>
