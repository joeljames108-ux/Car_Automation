  ...
  return (
    <div className="bg-white/80 dark:bg-base-900/90 border border-slate-200 dark:border-amber-800/30 rounded-3xl p-4 backdrop-blur-xl shadow-xl space-y-3 font-mono">
      ...
      <div className="flex items-center justify-between text-xs">
        ...
        <div className="text-[11px] text-amber-300/50 dark:text-amber-200/60">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className={isSelected ? 'text-amber-500 dark:text-amber-400' : 'text-amber-300/50'}>
                      {BODY_ICONS[bt]}
                    </span>
                    <strong className="text-xs font-bold text-slate-800 dark:text-amber-50">
                      {meta.name}
                    </strong>
                  </div>
                ...
                <div className="flex items-center justify-between text-[10px] text-amber-300/50 dark:text-amber-200/60 pt-0.5">
                  <div>
                    <span>WB: </span>
