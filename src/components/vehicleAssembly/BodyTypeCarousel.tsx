            ...
            return (
              <div
                ...
                className={`min-w-[210px] p-3.5 rounded-2xl border cursor-pointer transition-all duration-200 space-y-2 select-none ${
                  isSelected
                    ? 'bg-cyan-500/10 dark:bg-cyan-950/40 border-cyan-500 dark:border-cyan-400 shadow-[0_0_15px_rgba(6,182,212,0.3)] scale-102'
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className={isSelected ? 'text-cyan-500 dark:text-cyan-400' : 'text-slate-500'}>
                      {BODY_ICONS[bt]}
                    </span>
