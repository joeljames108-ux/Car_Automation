...
export const AutonomousDrivetrainSafetyDeck: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-slate-900/80 text-gray-100 p-4 gap-4 overflow-y-auto font-sans">
      ...
      <div className="flex items-center gap-4 px-4 py-2.5 bg-slate-900/80 rounded-xl border border-[#182133]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 flex-1">
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-slate-900/80 border border-[#182133] gap-3">
          ...
          <div className="p-2 rounded-lg bg-slate-900/80 border border-[#1c263d] text-[10px] font-mono text-gray-400">
