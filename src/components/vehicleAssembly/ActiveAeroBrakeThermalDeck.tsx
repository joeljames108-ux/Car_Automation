    ...
    <div className="flex flex-col h-full w-full bg-[#05070c] text-gray-100 p-4 gap-4 overflow-y-auto font-sans">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${
              isBrakingHard
                ...
                : 'bg-[#151c2e] text-gray-300 border border-[#232e48] hover:bg-[#1c263d]'
            }`}
          >
            AIRBRAKE TEST (HOLD)
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1">
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-[#090d16] border border-[#182133] gap-3">
          ...
          <div className="flex items-center justify-center p-4 bg-[#05070c] rounded-xl border border-[#141b2b]">
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-[#090d16] border border-[#182133] gap-3">
          ...
          <div className="grid grid-cols-2 gap-3 p-3 bg-[#05070c] rounded-xl border border-[#141b2b] text-center">
            {/* Front Left */}
