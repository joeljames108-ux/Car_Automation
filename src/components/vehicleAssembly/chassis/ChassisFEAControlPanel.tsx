...
export const ChassisFEAControlPanel: React.FC<ChassisFEAControlPanelProps> = ({
  ...
  return (
    <div className="bg-amber-950/90 backdrop-blur-md border border-amber-500/30 rounded-xl p-4 shadow-2xl text-amber-50 flex flex-col gap-3.5">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-amber-800/30 pb-2">
        ...
        <div className="flex items-center gap-1.5 px-2 py-0.5 bg-amber-900/50 border border-amber-700/30 rounded text-[10px] font-mono text-amber-200/60">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-between text-[11px] font-mono">
            <span className="text-amber-200/60">Cornering G-Load</span>
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-between text-[11px] font-mono">
            <span className="text-amber-200/60">Braking Decel</span>
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-between text-[11px] font-mono">
            <span className="text-amber-200/60">Aero Downforce</span>
      ...
      <div className="flex items-center justify-between pt-1 border-t border-amber-800/30 text-[11px]">
        <button
          onClick={() => setShowDeformationMesh(!showDeformationMesh)}
          className={`flex items-center gap-1.5 px-2.5 py-1 rounded transition-colors ${
            showDeformationMesh
              ? "bg-amber-950/80 text-amber-300 border border-amber-500/40"
              : "bg-amber-900/50 text-amber-200/60 border border-amber-800/30 hover:text-amber-50"
          }`}
        >
        ...
        <div className="flex items-center gap-3 text-amber-200/60 font-mono text-[10px]">
