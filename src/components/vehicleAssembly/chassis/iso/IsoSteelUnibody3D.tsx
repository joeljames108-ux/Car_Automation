...
interface IsoSteelUnibody3DProps {
  isHovered?: boolean;
}
 ...
 */
export const IsoSteelUnibody3D: React.FC<IsoSteelUnibody3DProps> = ({ isHovered = false }) => {
  return (
    <g id="biw-unibody-car-chassis-exact" className="transition-all duration-700 ease-out">
      {/* Defs for Metallic Steel Shading Gradients & Outer Glow */}
      <defs>
        {/* Main Body Steel Specular Metallic Gradient */}
        <linearGradient id="biw-steel-body-grad" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        <linearGradient id="biw-inner-cavity-grad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id="biw-sill-metallic-grad" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <filter id="biw-chassis-drop-shadow" x="-10%" y="-10%" width="120%" height="130%">
          <feDropShadow dx="0" dy="16" stdDeviation="12" floodColor="#020617" floodOpacity="0.6" />
        </filter>
      </defs>
      ...
      <g opacity="0.85">
        {/* Longitudinal Floor Channel Ribs */}
        ...
        {/* Front Seat Mounting Bracket (Right Door Cavity) */}
        ...
        {/* Rear Seat Base Mounting Cross-Member (Left Door Cavity) */}
        ...
        {/* Inner Rear Suspension Tower Dome Arch */}
      ...
      {/* Outer Shell Filled Path with Specular Metallic Steel Gradient */}
      <path
        d="M 900 250 
        ...
        fill="url(#biw-steel-body-grad)"
        stroke={isHovered ? "#38bdf8" : "#0f172a"}
        strokeWidth={isHovered ? "3.2" : "2.0"}
        strokeLinejoin="round"
        strokeLinecap="round"
        filter="url(#biw-chassis-drop-shadow)"
      />

      {/* ── LAYER 4: FRONT & REAR DOOR APERTURE CUTOUTS (Window & Door Holes) ── */}
      {/* Front Door Aperture Opening */}
      <path
        d="M 640 165 
      ...
      {/* Rear Door Aperture Opening (Fastback Kink Curve) */}
      <path
        d="M 485 125 
      ...
      {/* Upright Center B-Pillar Structure */}
      <path
      ...
      {/* Horizontal Rocker Sill Box Section */}
      <rect
        x="320"
        y="300"
        width="390"
      ...
      {/* Front Bumper Mounting Bracket (Far Right Rail Tip) */}
