...
export const AerodynamicWindTunnelViewport: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-900/80 text-gray-100 font-sans border border-[#1b2333] rounded-2xl overflow-hidden shadow-2xl">
      {/* Wind Tunnel Header */}
      <div className="flex items-center justify-between px-5 py-3 bg-slate-900/80 border-b border-[#1b2333]">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-900/80 hover:bg-slate-900/80 text-xs font-semibold border border-[#273248] transition-all"
          >
