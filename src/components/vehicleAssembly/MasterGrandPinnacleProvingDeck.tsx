...
export const MasterGrandPinnacleProvingDeck: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-slate-900/80 text-gray-100 p-4 gap-4 overflow-y-auto font-sans">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between px-6 py-4 rounded-2xl bg-slate-900/80 border border-[#1b263b] shadow-2xl gap-4">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-mono font-bold border transition-all flex items-center gap-2 ${
              isChargingMode
                ...
                : 'bg-slate-900/80 text-gray-300 border-[#24334a] hover:border-amber-500/40'
            }`}
          >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-mono font-bold whitespace-nowrap transition-all border ${
                isActive
                  ...
                  : 'bg-slate-900/80 border-[#152033] text-gray-400 hover:text-gray-200'
              }`}
            >
      ...
      <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 flex-1">
            {twinState.subsystemHealthSummaries.map((sub, idx) => (
              <div
                ...
                className="flex flex-col p-4 rounded-2xl bg-slate-900/80 border border-[#182338] shadow-md justify-between gap-3 hover:border-amber-500/40 transition-all"
              >
                ...
                <div className="p-2.5 rounded-xl bg-slate-900/80 border border-[#121c2e] text-[11px] font-mono text-amber-300">
        ...
        {activeTab === 'MEGAWATT_CHARGING' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1">
            <div className="flex flex-col p-5 rounded-2xl bg-slate-900/80 border border-[#182338] gap-4">
              ...
              <div className="p-4 rounded-xl bg-slate-900/80 border border-[#121c2e] flex flex-col gap-2 font-mono text-xs">
            ...
            <div className="lg:col-span-2 flex flex-col p-5 rounded-2xl bg-slate-900/80 border border-[#182338] gap-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs">
                {twinState.megawattCharging.contactPins.map((pin) => (
                  <div key={pin.pinId} className="p-3 rounded-xl bg-slate-900/80 border border-[#121c2e] flex flex-col gap-1.5">
            ...
            <div className="lg:col-span-2 flex flex-col p-5 rounded-2xl bg-slate-900/80 border border-[#182338] gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 font-mono text-xs">
                {twinState.ndtInspection.defectsDetected.map((d) => (
                  <div key={d.defectId} className="p-3 rounded-xl bg-slate-900/80 border border-[#121c2e] flex flex-col gap-1.5">
        ...
        {activeTab === 'PORPOISING_AERO' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1">
            ...
            <div className="lg:col-span-2 flex flex-col p-5 rounded-2xl bg-slate-900/80 border border-[#182338] gap-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs">
                <div className="p-3 rounded-xl bg-slate-900/80 border border-[#121c2e]">
        ...
        {activeTab === 'ELASTIC_BAND_AI' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1">
            ...
            <div className="lg:col-span-2 flex flex-col p-5 rounded-2xl bg-slate-900/80 border border-[#182338] gap-4">
              ...
              <div className="p-4 rounded-xl bg-slate-900/80 border border-[#121c2e] font-mono text-[11px] text-gray-300 flex flex-col gap-2">
