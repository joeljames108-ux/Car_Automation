  ...
  return (
    <div className="flex flex-col h-full w-full bg-amber-950/60 text-gray-100 p-4 gap-4 overflow-y-auto font-sans">
      ...
      <div className="flex items-center justify-between px-5 py-3 rounded-2xl bg-amber-950/60 border border-[#182133] shadow-lg">
        ...
        {/* Global Controls */}
        <div className="flex items-center gap-3">
          <label className="flex items-center gap-2 text-xs font-mono cursor-pointer bg-amber-950/60 px-3 py-1.5 rounded-xl border border-rose-500/30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 flex-1">
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-amber-950/60 border border-[#182133] gap-3">
          ...
          <div className="flex items-center justify-between p-2.5 bg-amber-950/60 rounded-xl border border-[#141b2b] text-xs font-mono">
            ...
            <select
              ...
              className="bg-amber-950/60 text-emerald-400 text-xs font-mono px-2 py-1 rounded border border-emerald-500/30"
            >
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-amber-950/60 border border-[#182133] gap-3 md:col-span-2">
          <div className="flex items-center justify-between pb-2 border-b border-[#182133]">
          ...
          <div className="p-3 bg-amber-950/60 rounded-xl border border-[#141b2b] text-[11px] font-mono text-gray-400 flex items-center justify-between">
