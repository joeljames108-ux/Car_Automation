    ...
    <div className="flex flex-col h-full w-full bg-slate-900/80 text-gray-100 p-4 gap-4 overflow-y-auto font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 flex-1">
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-slate-900/80 border border-[#182133] gap-3">
          ...
          <div className="flex items-center justify-between p-2.5 bg-slate-900/80 rounded-xl border border-[#141b2b] text-xs font-mono">
            ...
            <select
              ...
              className="bg-slate-900/80 text-amber-400 text-xs font-mono px-2 py-1 rounded border border-amber-500/30"
            >
        ...
        <div className="flex flex-col p-4 rounded-2xl bg-slate-900/80 border border-[#182133] gap-3">
          ...
          <div className="grid grid-cols-2 gap-2 p-2.5 bg-slate-900/80 rounded-xl border border-[#141b2b] text-xs font-mono">
            <div className="flex items-center justify-between">
              <span className="text-gray-400">FLUID:</span>
              <select
                value={fluidGrade}
                onChange={(e) => setFluidGrade(e.target.value as BrakeFluidGrade)}
                className="bg-slate-900/80 text-amber-400 text-[11px] font-mono px-1.5 py-0.5 rounded border border-amber-500/30"
              >
