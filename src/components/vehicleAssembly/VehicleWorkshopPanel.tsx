            ...
            {RIBBON_ITEMS.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-3.5 py-2 rounded-2xl text-xs font-bold whitespace-nowrap transition-all duration-200 border shadow-sm active:scale-[0.97] ${
                    isSelected
                      ? "bg-amber-500 text-slate-950 border-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.45)] scale-105"
                      : isInstalled
                      ? "bg-emerald-500/10 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 border-emerald-500/30 hover:border-emerald-400 hover:translate-y-[-1px]"
                      : installable
                      ? "bg-slate-100 dark:bg-base-950 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-800 hover:border-amber-500/40 hover:translate-y-[-1px]"
