...
export const VehicleAssemblyViewer: React.FC<VehicleAssemblyViewerProps> = ({
  ...
  return (
    <div
      className={`relative w-full rounded-3xl overflow-hidden bg-amber-900/40 dark:bg-base-950/90 border border-amber-700/30/60 dark:border-base-800/80 shadow-2xl backdrop-blur-xl flex flex-col ${className}`}
    >
      {/* Top HUD Controls Header */}
      <div className="flex flex-wrap items-center justify-between gap-4 p-4 border-b border-slate-200/50 dark:border-amber-800/30 bg-white/40 dark:bg-base-950/40 backdrop-blur-md z-20">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-mono text-sm font-black tracking-wider uppercase text-slate-900 dark:text-amber-50">
            ...
            <p className="text-xs text-amber-300/50 dark:text-amber-200/60 font-mono">
        ...
        <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl font-mono text-xs font-bold transition-all border ${
                isExplodedView
                  ...
                  : "bg-white/5 border-white/10 text-amber-200/60 hover:text-amber-50"
              }`}
            >
              Exploded View
            </button>
          ...
          <button
            ...
            className="p-2 rounded-2xl bg-slate-100 dark:bg-base-950 border border-slate-200 dark:border-amber-800/30 text-amber-400 dark:text-amber-200/60 hover:text-amber-500 dark:hover:text-amber-400 transition-all shadow-sm cursor-pointer"
          >
      ...
      <div className="relative w-full h-[520px] flex items-center justify-center bg-[#070d18]">
        ...
        {activeComponentId && activeMeta && (
          <div className="absolute top-4 left-4 z-30 flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-base-950/90 border border-amber-500/40 backdrop-blur-md shadow-[0_0_15px_rgba(6,182,212,0.3)] text-xs font-mono text-amber-50">
