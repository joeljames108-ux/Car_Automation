...
const TrackRacing3DViewportComponent: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[650px] bg-slate-950 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl">
      ...
      <div className="absolute top-20 left-4 bg-slate-900/85 backdrop-blur-md p-4 rounded-xl border border-slate-700/50 shadow-2xl w-80 space-y-3 pointer-events-auto">
        ...
        {/* Last Lap Time & Gap */}
        <div className="flex justify-between items-center bg-slate-950 p-2.5 rounded-lg border border-slate-800 font-mono text-xs">
          <span className="text-slate-400">LAST LAP:</span>
        ...
        <div className="space-y-1.5 font-mono text-xs">
          <div className="flex justify-between">
            <span className="text-slate-400">Tire Life Remaining:</span>
          ...
          <div className="flex justify-between pt-1">
            <span className="text-slate-400">Tire Temp (Surface):</span>
