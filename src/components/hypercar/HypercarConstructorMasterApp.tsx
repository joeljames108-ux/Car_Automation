...
const HypercarConstructorMasterAppComponent: React.FC<HypercarConstructorMasterAppProps> = ({
  ...
  return (
    <div className="w-full min-h-[750px] h-[calc(100vh-200px)] flex flex-col bg-amber-950/60 text-white relative overflow-hidden select-none rounded-2xl border border-white/10 shadow-2xl">
