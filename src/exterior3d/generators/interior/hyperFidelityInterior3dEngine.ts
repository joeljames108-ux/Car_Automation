...
export class HyperFidelityInterior3dEngine {
  ...
  private static buildSteeringWheelAssembly(
    ...
    const carbonMat = this.getPbrMaterial("carbon", "#080c14", 0.2, 0.9);
  ...
  private static buildCenterConsoleAssembly(
    ...
    const accentMat = this.getPbrMaterial("carbon", "#080c14", 0.25, 0.85);
  ...
  private static buildFrontSeatingAssembly(
    ...
    const shellMat = this.getPbrMaterial("carbon", "#080c14", 0.2, 0.9);
  ...
  private static buildPedalBoxAssembly(
    ...
    const rubberMat = this.getPbrMaterial("rubber", "#080c14", 0.8, 0.05);
