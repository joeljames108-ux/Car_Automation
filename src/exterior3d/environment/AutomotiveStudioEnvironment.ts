...
export const STUDIO_ENVIRONMENT_PRESETS: Record<StudioEnvironmentPreset, StudioEnvironmentConfig> = {
  ...
  titanium_slate: {
    ...
    rimLightColor: 0xec4899,
    rimLightIntensity: 1.4,
    gridPrimaryColor: 0x06b6d4,
  ...
  blueprint_navy: {
    ...
    rimLightColor: 0x60a5fa,
    rimLightIntensity: 1.6,
    gridPrimaryColor: 0x38bdf8,
    gridSecondaryColor: 0x1d4ed8,
    gridOpacity: 0.55,
