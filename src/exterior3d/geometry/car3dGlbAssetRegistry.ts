...
export class Car3DGlbAssetRegistry {
  public static readonly ASSETS: Record<string, CarGlbAssetDefinition> = {
    ...
    // ─── EXPANDED HIGH-FIDELITY INTERIOR MODULAR GLB ASSET REGISTRY ───
    INTERIOR_STEERING_FORMULA: {
      id: "INTERIOR_STEERING_FORMULA",
      name: "Formula-Style Carbon Yoke Steering Wheel GLB",
      subtitle: "Motorsport Dual-Clutch Carbon Yoke with Integrated LED Telemetry Display",
      description: "Full dry carbon open-top yoke wheel with 10 rotary thumb selectors, magnetic aluminum paddle shifters, and LED shift lights.",
      assetPath: "/models/interior/steering_formula.glb",
      category: "INTERIOR",
      wheelbaseMm: 0, lengthMm: 140, widthMm: 320, heightMm: 220,
      bodyPaintMaterialNames: ["yoke", "carbon", "button", "display"],
      suggestedCameraRadius: 1.2,
    },
    INTERIOR_STEERING_LUXURY_3SPOKE: {
      id: "INTERIOR_STEERING_LUXURY_3SPOKE",
      name: "Luxury 3-Spoke Billet & Nappa Steering Wheel GLB",
      subtitle: "Hand-Stitched Napa Leather with Satin Chrome Spokes & Capacitive Controls",
      description: "Classical 3-spoke luxury wheel featuring hand-grained Napa leather, illuminated capacitive touch controls, and heated rim core.",
      assetPath: "/models/interior/steering_luxury_3spoke.glb",
      category: "INTERIOR",
      wheelbaseMm: 0, lengthMm: 165, widthMm: 375, heightMm: 375,
      bodyPaintMaterialNames: ["leather", "chrome", "spoke", "wood"],
      suggestedCameraRadius: 1.4,
    },
    INTERIOR_STEERING_SUEDE_PERFORATED: {
      id: "INTERIOR_STEERING_SUEDE_PERFORATED",
      name: "Perforated Suede & Carbon Sport Wheel GLB",
      subtitle: "Alcantara Side Grips with 12 O'Clock Racing Marker & Billet Paddles",
      description: "High-friction suede wheel with perforated side grips, contrast diamond stitching, and extended billet aluminum shift paddles.",
      assetPath: "/models/interior/steering_suede_carbon.glb",
      category: "INTERIOR",
      wheelbaseMm: 0, lengthMm: 160, widthMm: 365, heightMm: 365,
      bodyPaintMaterialNames: ["suede", "alcantara", "carbon", "stitch"],
      suggestedCameraRadius: 1.3,
    },
    INTERIOR_SEAT_EXECUTIVE_LOUNGE: {
      id: "INTERIOR_SEAT_EXECUTIVE_LOUNGE",
      name: "Executive First-Class Lounge Chair GLB",
      subtitle: "24-Way Electric Seat with Extendable Calf Support & Pneumatic Massage",
      description: "First-class rear executive seat with folding ottoman legrest, hot-stone massage rollers, and ventilated perforation channels.",
      assetPath: "/models/interior/seat_executive_lounge.glb",
      category: "INTERIOR",
      wheelbaseMm: 0, lengthMm: 750, widthMm: 620, heightMm: 980,
      bodyPaintMaterialNames: ["leather", "piping", "stitch", "wood", "metal"],
      suggestedCameraRadius: 2.1,
    },
    INTERIOR_SEAT_VENTILATED_MASSAGE: {
      id: "INTERIOR_SEAT_VENTILATED_MASSAGE",
      name: "Ventilated & Massage Luxury Comfort Seat GLB",
      subtitle: "Semi-Aniline Leather with Dual Turbo Cooling Fans & Lumbar Air Chambers",
      description: "Ultra-plush semi-aniline leather bucket seat with active bolsters that adjust automatically during cornering.",
      assetPath: "/models/interior/seat_luxury_massage.glb",
      category: "INTERIOR",
      wheelbaseMm: 0, lengthMm: 640, widthMm: 580, heightMm: 940,
      bodyPaintMaterialNames: ["leather", "perforated", "cushion", "trim"],
      suggestedCameraRadius: 1.9,
    },
    INTERIOR_ROOF_STARLIGHT: {
      id: "INTERIOR_ROOF_STARLIGHT",
      name: "Panoramic Starlight Fiber-Optic Roof GLB",
      subtitle: "64-Color Illuminated Fiber-Optic Constellation Glass Roof",
      description: "Electrochromic panoramic glass roof embedded with 1,200 individual fiber-optic starlight shooting star LEDs.",
      assetPath: "/models/interior/roof_starlight.glb",
      category: "INTERIOR",
      wheelbaseMm: 0, lengthMm: 1800, widthMm: 1200, heightMm: 120,
      bodyPaintMaterialNames: ["headliner", "glass", "starlight", "led"],
      glassMaterialNames: ["glass", "panoramic"],
      suggestedCameraRadius: 2.5,
    },
    INTERIOR_PEDALS_RACE_BILLET: {
      id: "INTERIOR_PEDALS_RACE_BILLET",
      name: "Billet Aluminum & Carbon Competition Pedals GLB",
      subtitle: "Adjustable Heel-Toe Billet Pedal Box with Anti-Slip Rubber Pins",
      description: "Precision CNC-machined T6061 billet aluminum throttle, brake, and clutch pedal box with adjustable faceplate angles.",
      assetPath: "/models/interior/pedals_race.glb",
      category: "INTERIOR",
      wheelbaseMm: 0, lengthMm: 320, widthMm: 340, heightMm: 280,
      bodyPaintMaterialNames: ["aluminum", "rubber", "carbon", "pedal"],
      suggestedCameraRadius: 1.1,
    },
  };
