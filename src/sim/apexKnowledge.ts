...
export function getImpactBadges(impacts: ImpactArea[]): { label: string; color: string }[] {
  const IMPACT_COLORS: Record<ImpactArea, string> = {
    ...
    weight: "bg-purple-500/20 text-purple-300 border-purple-500/30",
    cost: "bg-emerald-500/20 text-emerald-300 border-emerald-500/30",
    handling: "bg-cyan-500/20 text-cyan-300 border-cyan-500/30",
    aero: "bg-sky-500/20 text-sky-300 border-sky-500/30",
    reliability: "bg-blue-500/20 text-blue-300 border-blue-500/30",
    ...
    noise: "bg-violet-500/20 text-violet-300 border-violet-500/30",
    ...
    durability: "bg-indigo-500/20 text-indigo-300 border-indigo-500/30",
