...
export const PLATFORM_FAMILIES: Record<PlatformFamilyId, PlatformFamilySpec> = {
  ...
  body_on_frame_truck: {
    ...
    allowedBodyTypes: ["pickup_truck", "offroad_4x4", "truck_lorry"],
    defaultDriveType: "awd",
    allowedEnginePositions: ["front"],
  ...
  commercial_van_bus: {
    ...
    allowedBodyTypes: ["cargo_van", "bus_shuttle"],
    defaultDriveType: "fwd",
    allowedEnginePositions: ["front"],
...
export const BODY_TYPE_REGISTRY: Record<VehicleBodyTypeId, VehicleBodyTypeSpec> = {
  ...
  luxury_sedan: {
    ...
    morphSourceId: "sedan",
    morphParameters: {
      roofLengthDeltaMm: 120,
      roofHeightDeltaMm: 40,
      doorLengthDeltaMm: 90,
      rearRakeAngleDeg: 22,
    ...
    defaultDimensions: {
      ...
      frontTrackMm: 1640,
      rearTrackMm: 1660,
      overallLengthMm: 5250,
      overallWidthMm: 1930,
      overallHeightMm: 1490,
      groundClearanceMm: 145,
      frontOverhangMm: 930,
      rearOverhangMm: 1170,
      cabinLengthMm: 2450,
    ...
    seatingCapacity: 4,
    cargoCapacityL: 530,
    aerodynamicBaseline: { cd: 0.26, frontalAreaM2: 2.35, clBase: -0.04 },
  },
  coupe: {
    id: "coupe",
    name: "Coupe",
  ...
  // --- 4. Body-on-Frame Truck & Commercial (2) ---
  pickup_truck: {
    id: "pickup_truck",
    name: "Pickup Truck",
  ...
  truck_lorry: {
    ...
    defaultDimensions: {
      ...
      frontTrackMm: 1820,
      rearTrackMm: 1840,
      overallLengthMm: 6950,
      overallWidthMm: 2400,
      overallHeightMm: 2750,
    ...
    seatingCapacity: 3,
    cargoCapacityL: 8500,
    aerodynamicBaseline: { cd: 0.50, frontalAreaM2: 4.60, clBase: 0.05 },
  },
