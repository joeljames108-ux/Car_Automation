...
export function emptyEngine(): EngineConfig {
  return {
    layout: "unconfigured",
    bore: 0,
    stroke: 0,
    ...
    wastegateSize: 0,
    intercoolerEff: 0,
    turboHousing: "cast_iron",
    compressorAR: 0.5,
    turbineAR: 0.6,
    turbineWheelDia: 45,
    intercoolerType: "none",
    wastegateType: "none",
    bovType: "none",
    antiLag: false,
    boostController: "none",
    fuelSystem: "carb",
    afr: 14.7,
    ignitionTiming: 10,
    rpmLimiter: 0,
    ...
    coolingWaterPump: 0,
    coolingFanSpeed: 0,
    exhaustPrimaryLength: 0,
    exhaustCollectorDia: 0,
    exhaustCat: false,
    exhaustValved: false,
    hasStartStop: false,
    ecuMapMode: "economy",
    ...
    motorPlacement: "p2",
    hybridMotorPower: 0,
    powerElectronicsType: "standard_igbt",
    voltageArchitecture: 400,
    hybridTransmission: "single_speed_reduction",
    regenBrakingTech: "brake_by_wire",
    thermalManagement: "air_cooling",
    chargingTech: "ccs2",
    engineStrategy: "auto_start_stop",
    sensorSuite: "basic" as any,
    emissionsTech: "three_way_cat",
    safetySystems: "basic" as any,
    futureTech: "none" as any,
    sportsHybridTech: "none" as any,
  };
}
...
export function emptyAero(): AeroConfig {
  return {
    bodyShape: 0,
    bodyWidth: 0,
    roofHeight: 0,
...
export function emptyAeroResearch(): AeroResearchConfig {
  return {
    front: {
      bumperShape: "standard",
      airDam: 0,
...
export function emptyInterior(): InteriorConfig {
  return {
    seatType: "standard",
    seatMaterial: "cloth",
    seatCount: 0,
...
export function emptyExterior(): ExteriorConfig {
  return {
    bodyType: "unconfigured",
    paintColor: "#222228",
    paintFinish: "matte",
    rimDesign: "steel_stamped",
    rimFinish: "matte_black",
    rimDiameter: 0,
    rimWidth: 0,
    headlightType: "halogen_reflector",
    taillightType: "bulb",
    bodyKit: "none",
    spoilerType: "none",
    roofScoop: "none",
...
export function emptyVehicle(): VehicleConfig {
  return {
    platform: "unconfigured",
    driveType: "rwd",
    enginePosition: "front",
    chassis: "pressed_steel",
    exterior: emptyExterior(),
    aero: emptyAero(),
    aeroResearch: emptyAeroResearch(),
    suspensionFront: "macpherson",
    suspensionRear: "torsion_beam",
    springRateF: 0,
    springRateR: 0,
    damperF: 0,
    damperR: 0,
...
export function emptyDesign(): VehicleDesign {
  return {
    name: "Unconfigured Vehicle Project",
    description: "Build-from-zero modular engineering project — awaiting subsystem configuration",
    engine: emptyEngine(),
