"""
=============================================================================
RENDER FERRARI 812 GTS (PHASE 35 & 36) ASSESSMENT VIEWS
=============================================================================
Renders 5 standard automotive validation angles:
1. Front 3/4 Hero (Swept LED headlights, carbon splitter, active grille, 20" diamond-cut wheels)
2. Rear 3/4 (Sculpted flying buttresses, quad circular taillights, triplane diffuser, quad exhaust)
3. Side Profile (Classic front-mid V12 proportions, draped flank crease, Scuderia fender shields)
4. Front Elevation (Wide aggressive stance, center Cavallino badge, vented hood louvers)
5. Rear Elevation (Quad circular taillight rings, quad titanium exhaust tips, rear wind-stop)
=============================================================================
"""
...
if "generate_ferrari_812_gts_phase2" in sys.modules:
    del sys.modules["generate_ferrari_812_gts_phase2"]

import generate_ferrari_812_gts_phase2
print("[RENDER] Executing Ferrari 812 GTS master complete build...")
generate_ferrari_812_gts_phase2.build_ferrari_812_gts_phase2()
...
# Key Light (Cool-Neutral Key for Rosso Corsa specular highlights)
...
# Rim Light (Accent on sculptural rear buttresses and haunches)
...
# Angle definitions for Ferrari 812 GTS (L=4.693m, W=1.971m, H=1.276m)
angles = [
    ("ferrari_812_gts_front_three_quarter", (5.2,  5.0, 1.45), (0.0,  0.25, 0.60), 50.0),
    ("ferrari_812_gts_rear_three_quarter",  (5.2, -5.0, 1.45), (0.0, -0.25, 0.60), 50.0),
    ("ferrari_812_gts_side_profile",        (6.5,  0.0, 0.72), (0.0,  0.00, 0.60), 48.0),
    ("ferrari_812_gts_front_elevation",     (0.0,  5.2, 0.68), (0.0,  0.25, 0.60), 50.0),
    ("ferrari_812_gts_rear_elevation",      (0.0, -5.2, 0.68), (0.0, -0.25, 0.60), 50.0),
]
...
print("[COMPLETE] All 5 Ferrari 812 GTS assessment views rendered successfully.")
