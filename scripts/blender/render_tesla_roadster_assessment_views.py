"""
=============================================================================
RENDER TESLA ROADSTER GEN 2 / CYBER ROADSTER ASSESSMENT VIEWS
=============================================================================
Renders 5 standard automotive validation angles:
1. Front 3/4 Hero (Carbon splitter, knife-edge laser headlights, frunk extractors, aero turbine wheels)
2. Rear 3/4 (Active aero wing, pulse-ribbon taillamp, dual-tier venturi diffuser, cold-gas thrusters)
3. Side Profile (Coke-bottle silhouette, low drag profile, flush touch door actuators, removable targa)
4. Front Elevation (Wide stance, slit DRLs, autonomous camera frit pod, low splitter)
5. Rear Elevation (Full-width neon light ribbon, SpaceX thruster bells, carbon venturi tunnels)
=============================================================================
"""
...
if "generate_tesla_roadster_phase2" in sys.modules:
    del sys.modules["generate_tesla_roadster_phase2"]

import generate_tesla_roadster_phase2
print("[RENDER] Executing Tesla Roadster Gen 2 master complete build...")
generate_tesla_roadster_phase2.build_tesla_roadster_phase2()
...
# Key Light (Cool-Neutral Key for Ultra Red Multi-Coat specular highlights)
...
# Angle definitions for Tesla Roadster Gen 2 (L=4.480m, W=1.980m, H=1.220m)
angles = [
    ("tesla_roadster_front_three_quarter", (5.0,  5.0, 1.45), (0.0,  0.20, 0.58), 50.0),
    ("tesla_roadster_rear_three_quarter",  (5.0, -5.0, 1.45), (0.0, -0.20, 0.58), 50.0),
    ("tesla_roadster_side_profile",        (6.2,  0.0, 0.70), (0.0,  0.00, 0.58), 48.0),
    ("tesla_roadster_front_elevation",     (0.0,  5.0, 0.65), (0.0,  0.20, 0.58), 50.0),
    ("tesla_roadster_rear_elevation",      (0.0, -5.0, 0.65), (0.0, -0.20, 0.58), 50.0),
]
...
print("[COMPLETE] All 5 Tesla Roadster Gen 2 assessment views rendered successfully.")
