...
candidates = [
    ("pass_sport_1.png", Vector((0.36, -0.78, 0.98)), Vector((-0.20, 0.10, 0.65)), 22.0),
    ("pass_sport_2.png", Vector((0.42, -0.74, 1.02)), Vector((-0.18, 0.12, 0.64)), 20.0),
    ("pass_sport_3.png", Vector((0.30, -0.82, 0.96)), Vector((-0.22, 0.08, 0.65)), 24.0),
]
