"""
=============================================================================
RENDER PEUGEOT 205 GTI 1.9 (1980s HATCHBACK) ASSESSMENT VIEWS
=============================================================================
Renders high-fidelity beauty assessment shots of the generated Peugeot 205 GTi 1.9:
1. Front 3/4 Hero (Rouge Vallelunga paint, 3-slat grille, yellow fog lamps, Speedlines)
2. Rear 3/4 (Ribbed multi-chamber taillights, tailgate applique, oval exhaust, spoiler)
3. Side Profile (15" Speedline SL299 wheels, red pinstripe cladding, C-pillar 1.9 badge)
4. Front Elevation (Front air dam, yellow driving lamps, chrome lion, slanted halogens)
5. Rear Elevation (Ribbed tailgate panel, red bumper pinstripe, oval chrome tailpipe)
=============================================================================
"""
...
if "generate_peugeot_205_gti" in sys.modules:
    del sys.modules["generate_peugeot_205_gti"]
import generate_peugeot_205_gti
from generate_peugeot_205_gti import build_peugeot_205_gti_master

# Build Peugeot 205 GTi from completely purged slate
...
# Angle definitions for Peugeot 205 GTi (L=3.705m, W=1.572m, H=1.355m)
angles = [
    ("peugeot_front_three_quarter", (4.2,  4.2, 1.35), (0.0,  0.10, 0.62), 50.0),
    ("peugeot_rear_three_quarter",  (4.2, -4.2, 1.35), (0.0, -0.10, 0.62), 50.0),
    ("peugeot_side_profile",        (5.5,  0.0, 0.70), (0.0,  0.00, 0.62), 55.0),
    ("peugeot_front_elevation",     (0.0,  4.8, 0.65), (0.0,  0.15, 0.58), 50.0),
    ("peugeot_rear_elevation",      (0.0, -4.8, 0.65), (0.0, -0.15, 0.60), 50.0),
]
...
print("[COMPLETE] All 5 Peugeot 205 GTi assessment views rendered successfully.")
