"""
=============================================================================
RENDER MAZDA MX-5 MIATA (NA) (PHASE 27 & 28) ASSESSMENT VIEWS
=============================================================================
Renders 5 standard automotive validation angles:
1. Front 3/4 Hero (Retractable pop-up headlamps deployed, smile air dam, 14" daisy alloy wheels, organic hood)
2. Rear 3/4 (Oval tri-color taillamp clusters, single right polished exhaust, folded tonneau boot, trunk badges)
3. Side Profile (Pure Lotus Elan inspired organic roadster silhouette, flush door handles, fender repeater, 50:50 stance)
4. Front Elevation (Winking pop-up headlamps, smile grille mouth, low front air dam, aerodynamic cowl)
5. Rear Elevation (Classic oval taillights, center license plate recess, chrome Mazda/Miata script, right exhaust tip)
=============================================================================
"""
...
if "generate_mazda_miata_na_phase2" in sys.modules:
    del sys.modules["generate_mazda_miata_na_phase2"]

import generate_mazda_miata_na_phase2
print("[RENDER] Executing Mazda MX-5 Miata (NA) master complete build...")
generate_mazda_miata_na_phase2.build_mazda_miata_na_phase2()
...
# Key Light (Warm Key for Classic Red gloss highlights)
...
# Rim Light (Accent on pop-ups and rear quarter haunch)
...
# Angle definitions for Mazda Miata NA (L=3.970m, W=1.675m, H=1.225m)
angles = [
    ("mazda_miata_front_three_quarter", (4.4,  4.5, 1.30), (0.0,  0.20, 0.55), 52.0),
    ("mazda_miata_rear_three_quarter",  (4.4, -4.5, 1.30), (0.0, -0.20, 0.55), 52.0),
    ("mazda_miata_side_profile",        (5.8,  0.0, 0.65), (0.0,  0.00, 0.55), 50.0),
    ("mazda_miata_front_elevation",     (0.0,  4.6, 0.62), (0.0,  0.20, 0.55), 52.0),
    ("mazda_miata_rear_elevation",      (0.0, -4.6, 0.62), (0.0, -0.20, 0.55), 52.0),
]
...
print("[COMPLETE] All 5 Mazda MX-5 Miata (NA) assessment views rendered successfully.")
