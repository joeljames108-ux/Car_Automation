"""
=============================================================================
RENDER VOLKSWAGEN GOLF GTI MK1 ASSESSMENT VIEWS
=============================================================================
Renders high-fidelity beauty assessment shots of the generated Volkswagen Golf GTI Mk1:
1. Front 3/4 Hero (Giugiaro folded-paper hood, red-framed grille, round headlamps)
2. Rear 3/4 Hatchback (Upright 2-box silhouette, small ribbed taillights, pea-shooter exhaust)
3. Side Profile (Compact wheelbase, black rocker GTI stripes, flared fender arches)
4. Front Elevation (Central VW chrome emblem, red pinstripe grille, chin air dam spoiler)
5. Rear Elevation (Small rectangular taillights, black window frame, exhaust tailpipe)
=============================================================================
"""
...
if "generate_volkswagen_golf_gti_mk1" in sys.modules:
    del sys.modules["generate_volkswagen_golf_gti_mk1"]
import generate_volkswagen_golf_gti_mk1
from generate_volkswagen_golf_gti_mk1 import build_volkswagen_golf_gti_mk1_master

# Build Golf GTI Mk1 in current scene from scratch
...
# Angle definitions for Volkswagen Golf GTI Mk1 (L=3.705m, W=1.610m, H=1.390m)
angles = [
    ("golf_front_three_quarter", (4.5,  4.5, 1.45), (0.0,  0.10, 0.65), 50.0),
    ("golf_rear_three_quarter",  (4.5, -4.5, 1.45), (0.0, -0.10, 0.65), 50.0),
    ("golf_side_profile",        (6.0,  0.0, 0.75), (0.0,  0.00, 0.65), 55.0),
    ("golf_front_elevation",     (0.0,  5.2, 0.70), (0.0,  0.15, 0.62), 50.0),
    ("golf_rear_elevation",      (0.0, -5.2, 0.70), (0.0, -0.15, 0.65), 50.0),
]
...
print("[COMPLETE] All 5 Volkswagen Golf GTI Mk1 assessment views rendered successfully.")
