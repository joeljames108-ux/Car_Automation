...
candidates = [
    ("exact_sport_1.png", Vector((0.08, -0.68, 0.95)), Vector((-0.14, 0.12, 0.62)), 22.0),
    ("exact_sport_2.png", Vector((0.15, -0.72, 0.98)), Vector((-0.12, 0.10, 0.60)), 20.0),
    ("exact_sport_3.png", Vector((0.00, -0.65, 0.92)), Vector((-0.15, 0.15, 0.62)), 22.0),
    ("exact_sport_4.png", Vector((0.18, -0.62, 0.92)), Vector((-0.16, 0.15, 0.62)), 22.0),
]
