...
candidates = [
    ("driver_shoulder_1.png", Vector((-0.12, -0.78, 0.98)), Vector((0.08, 0.12, 0.60)), 21.0),
    ("driver_shoulder_2.png", Vector((-0.08, -0.82, 1.02)), Vector((0.05, 0.10, 0.58)), 20.0),
    ("driver_shoulder_3.png", Vector((-0.16, -0.75, 0.95)), Vector((0.10, 0.14, 0.60)), 22.0),
    ("driver_shoulder_4.png", Vector((-0.04, -0.85, 1.00)), Vector((0.06, 0.10, 0.58)), 19.0),
]
