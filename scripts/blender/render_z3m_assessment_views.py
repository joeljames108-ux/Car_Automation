"""
=============================================================================
RENDER BMW Z3 M ROADSTER (PHASE 29 & 30) ASSESSMENT VIEWS
=============================================================================
Renders 5 standard automotive validation angles:
1. Front 3/4 Hero (Twin chrome kidney grilles, dual twin projector lamps, M side gills, 17" deep-dish RoadStar wheels)
2. Rear 3/4 (Voluptuous flared rear widebody haunches, quad chrome exhaust pipes, twin chrome roll hoops, L-shaped taillights)
3. Side Profile (Dramatic long-hood/short-deck roadster stance, M fender cooling gills with roundels, deep-dish lip)
4. Front Elevation (Wide aggressive M bumper, circular brake ducts, kidney grilles, raked windshield)
5. Rear Elevation (Muscular widebody haunches, quad exhaust outlets flanking license recess, twin roll hoops)
=============================================================================
"""
...
if "generate_bmw_z3m_roadster_phase2" in sys.modules:
    del sys.modules["generate_bmw_z3m_roadster_phase2"]

import generate_bmw_z3m_roadster_phase2
print("[RENDER] Executing BMW Z3 M Roadster master complete build...")
generate_bmw_z3m_roadster_phase2.build_bmw_z3m_roadster_phase2()
...
# Key Light (Cool-Neutral Key for Estoril Blue Metallic specular highlights)
...
# Rim Light (Accent on flared rear haunches and chrome roll hoops)
...
# Angle definitions for BMW Z3 M Roadster (L=4.025m, W=1.740m, H=1.266m)
angles = [
    ("bmw_z3m_front_three_quarter", (4.5,  4.5, 1.35), (0.0,  0.20, 0.58), 52.0),
    ("bmw_z3m_rear_three_quarter",  (4.5, -4.5, 1.35), (0.0, -0.20, 0.58), 52.0),
    ("bmw_z3m_side_profile",        (5.8,  0.0, 0.70), (0.0,  0.00, 0.58), 50.0),
    ("bmw_z3m_front_elevation",     (0.0,  4.6, 0.65), (0.0,  0.20, 0.58), 52.0),
    ("bmw_z3m_rear_elevation",      (0.0, -4.6, 0.65), (0.0, -0.20, 0.58), 52.0),
]
...
print("[COMPLETE] All 5 BMW Z3 M Roadster assessment views rendered successfully.")
