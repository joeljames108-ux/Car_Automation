"""
=============================================================================
RENDER TRIUMPH SPITFIRE 1500 (PHASE 25 & 26) ASSESSMENT VIEWS
=============================================================================
Renders 5 standard automotive validation angles:
1. Front 3/4 Hero (Twin round Lucas headlamps, chrome bumper with rubber overriders, power bulge, 13" Rostyle wheels)
2. Rear 3/4 (Truncated Kamm tail, split chrome bumperettes, rectangular Lucas lamps, center Monza flip cap, dual pea-shooters)
3. Side Profile (Classic Michelotti cutaway door line, low frameless windshield, bullet wing mirror, front clamshell shutline)
4. Front Elevation (Wide low roadster stance, grille mouth, chrome overrider plinths, Lucas fluted glass)
5. Rear Elevation (Squared Kamm apron, dual upswept exhausts, yellow stamped plate, cursive Spitfire 1500 script)
=============================================================================
"""
...
if "generate_triumph_spitfire_1500_phase2" in sys.modules:
    del sys.modules["generate_triumph_spitfire_1500_phase2"]

import generate_triumph_spitfire_1500_phase2
print("[RENDER] Executing Triumph Spitfire 1500 master complete build...")
generate_triumph_spitfire_1500_phase2.build_triumph_spitfire_1500_phase2()
...
# Key Light (Warm Key for Inca Yellow gloss highlights and mirror chrome reflections)
...
# Angle definitions for Triumph Spitfire 1500 (L=3.780m, W=1.488m, H=1.205m)
angles = [
    ("triumph_spitfire_front_three_quarter", (4.2,  4.4, 1.25), (0.0,  0.20, 0.55), 52.0),
    ("triumph_spitfire_rear_three_quarter",  (4.2, -4.4, 1.25), (0.0, -0.20, 0.55), 52.0),
    ("triumph_spitfire_side_profile",        (5.5,  0.0, 0.65), (0.0,  0.00, 0.55), 50.0),
    ("triumph_spitfire_front_elevation",     (0.0,  4.5, 0.60), (0.0,  0.20, 0.55), 52.0),
    ("triumph_spitfire_rear_elevation",      (0.0, -4.5, 0.60), (0.0, -0.20, 0.55), 52.0),
]
...
print("[COMPLETE] All 5 Triumph Spitfire 1500 assessment views rendered successfully.")
